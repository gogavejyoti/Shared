(function(t, e) {
    "object" === typeof exports && "object" === typeof module ? module.exports = e(require("echarts"), require("Vuex"), require("Vue")) : "function" === typeof define && define.amd ? define(["echarts", "Vuex", "Vue"], e) : "object" === typeof exports ? exports["chartmix"] = e(require("echarts"), require("Vuex"), require("Vue")) : t["chartmix"] = e(t["echarts"], t["Vuex"], t["Vue"])
}
 ...
 */
            (function(e, n) {
                ...
                O.extend = O.fn.extend = function() {
                    var t, e, n, r, i, a, o = arguments[0] || {}, s = 1, l = arguments.length, c = !1;
                    ...
                    s--); s < l; s++)
                        if (null != (t = arguments[s]))
                            for (e in t)
                                r = t[e],
                                "__proto__" !== e && o !== r && (c && r && (O.isPlainObject(r) || (i = Array.isArray(r))) ? (n = o[e],
                                a = i && !Array.isArray(n) ? [] : i || O.isPlainObject(n) ? n : {},
                                i = !1,
                                o[e] = O.extend(c, a, r)) : void 0 !== r && (o[e] = r));
                    return o
                }
                ,
                O.extend({
                    ...
                    isPlainObject: function(t) {
                        var e, n;
                        return !(!t || "[object Object]" !== p.call(t)) && (e = s(t),
                        !e || (n = d.call(e, "constructor") && e.constructor,
                    ...
                    makeArray: function(t, e) {
                        var n = e || [];
                        return null != t && (T(Object(t)) ? O.merge(n, "string" === typeof t ? [t] : t) : u.call(n, t)),
                        n
                    },
                    ...
                    grep: function(t, e, n) {
                        for (var r, i = [], a = 0, o = t.length, s = !n; a < o; a++)
                            r = !e(t[a], a),
                            r !== s && i.push(t[a]);
                        return i
                    },
                ...
                "function" === typeof Symbol && (O.fn[Symbol.iterator] = o[Symbol.iterator]),
                O.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "), (function(t, e) {
                ...
                var R = x
                  , B = u;
                (function() {
                    var t, e, r, i, a, s, c, u, f, p, g = B, m = O.expando, v = 0, y = 0, x = et(), A = et(), w = et(), C = et(), S = function(t, e) {
                        return t === e && (a = !0),
                        0
                    }, k = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", T = "(?:\\\\[\\da-fA-F]{1,6}" + G + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", N = "\\[" + G + "*(" + T + ")(?:" + G + "*([*^$|!~]?=)" + G + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + T + "))|)" + G + "*\\]", M = ":(" + T + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + N + ")*)|.*)\\)|)", V = new RegExp(G + "+","g"), P = new RegExp("^" + G + "*," + G + "*"), z = new RegExp("^" + G + "*([>+~]|" + G + ")" + G + "*"), Q = new RegExp(G + "|>"), W = new RegExp(M), F = new RegExp("^" + T + "$"), q = {
                        ID: new RegExp("^#(" + T + ")"),
                        CLASS: new RegExp("^\\.(" + T + ")"),
                        TAG: new RegExp("^(" + T + "|[*])"),
                        ATTR: new RegExp("^" + N),
                    ...
                    }, X = /^(?:input|select|textarea|button)$/i, H = /^h\d$/i, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, J = /[+~]/, U = new RegExp("\\\\[\\da-fA-F]{1,6}" + G + "?|\\\\([^\\r\\n\\f])","g"), Y = function(t, e) {
                    ...
                    try {
                        g.apply(o = l.call(R.childNodes), R.childNodes),
                        ...
                        g = {
                            ...
                            call: function(t) {
                                B.apply(t, l.call(arguments, 1))
                            }
                        }
                    }
                    function tt(t, e, n, r) {
                        var i, a, o, l, c, h, p, d = e && e.ownerDocument, v = e ? e.nodeType : 9;
                        if (n = n || [],
                        ...
                        u)) {
                                ...
                                if (i = c[1]) {
                                    if (9 === v) {
                                        ...
                                        if (o.id === i)
                                            return g.call(n, o),
                                            n
                                    } else if (d && (o = d.getElementById(i)) && tt.contains(e, o) && o.id === i)
                                        return g.call(n, o),
                                        n
                                } else {
                                    if (c[2])
                            ...
                            if (!C[t + " "] && (!f || !f.test(t))) {
                                if (p = t,
                                d = e,
                                1 === v && (Q.test(t) || z.test(t))) {
                                    d = J.test(t) && lt(e.parentNode) || e,
                                    d == e && b.scope || ((l = e.getAttribute("id")) ? l = O.escapeSelector(l) : e.setAttribute("id", l = m)),
                                    h = ht(t),
                                    a = h.length;
                                    while (a--)
                                        h[a] = (l ? "#" + l : ":scope") + " " + ft(h[a]);
                                    p = h.join(",")
                                }
                                try {
                    ...
                    function ot(t) {
                        return function(e) {
                            return "form"in e ? e.parentNode && !1 === e.disabled ? "label"in e ? "label"in e.parentNode ? e.parentNode.disabled === t : e.disabled === t : e.isDisabled === t || e.isDisabled !== !t && _(e) === t : e.disabled === t : "label"in e && e.disabled === t
                        }
                    }
                    function st(t) {
                        return nt((function(e) {
                            return e = +e,
                            nt((function(n, r) {
                                var i, a = t([], n.length, e), o = a.length;
                                while (o--)
                                    n[i = a[o]] && (n[i] = !(r[i] = n[i]))
                            }
                            ))
                    ...
                    function ct(t) {
                        ...
                        R != s && (n = s.defaultView) && n.top !== n && n.addEventListener("unload", K),
                        b.getById = rt((function(t) {
                            return c.appendChild(t).id = O.expando,
                            !s.getElementsByName || !s.getElementsByName(O.expando).length
                        }
                        )),
                        b.disconnectedMatch = rt((function(t) {
                            return p.call(t, "*")
                        }
                        )),
                        b.scope = rt((function() {
                        ...
                        e.find.ID = function(t, e) {
                            if ("undefined" !== typeof e.getElementById && u) {
                        ...
                        e.find.CLASS = function(t, e) {
                            if ("undefined" !== typeof e.getElementsByClassName && u)
                        ...
                        rt((function(t) {
                            ...
                            t.querySelectorAll("[selected]").length || f.push("\\[" + G + "*(?:value|" + k + ")"),
                            ...
                            e.setAttribute("name", ""),
                            t.appendChild(e),
                            t.querySelectorAll("[name='']").length || f.push("\\[" + G + "*name" + G + "*=" + G + "*(?:''|\"\")")
                        }
                        )),
                        b.cssHas || f.push(":has"),
                        ...
                        S = function(t, e) {
                            ...
                            1 & n || !b.sortDetached && e.compareDocumentPosition(t) === n ? t === s || t.ownerDocument == R && tt.contains(R, t) ? -1 : e === s || e.ownerDocument == R && tt.contains(R, e) ? 1 : i ? h.call(i, t) - h.call(i, e) : 0 : 4 & n ? -1 : 1)
                        }
                        ,
                        s) : s
                    }
                    ...
                    tt.matchesSelector = function(t, e) {
                        ...
                        return tt(e, s, null, [t]).length > 0
                    }
                    ,
                    tt.contains = function(t, e) {
                        return (t.ownerDocument || t) != s && ct(t),
                        O.contains(t, e)
                    }
                    ,
                    tt.attr = function(t, n) {
                        ...
                        var r = e.attrHandle[n.toLowerCase()]
                          , i = r && d.call(e.attrHandle, n.toLowerCase()) ? r(t, n, !u) : void 0;
                    ...
                    e = O.expr = {
                        ...
                        preFilter: {
                            ATTR: function(t) {
                                return t[1] = t[1].replace(U, Y),
                                t[3] = (t[3] || t[4] || t[5] || "").replace(U, Y),
                                "~=" === t[2] && (t[3] = " " + t[3] + " "),
                                t.slice(0, 4)
                            },
                            CHILD: function(t) {
                                return t[1] = t[1].toLowerCase(),
                                "nth" === t[1].slice(0, 3) ? (t[3] || tt.error(t[0]),
                                t[4] = +(t[4] ? t[5] + (t[6] || 1) : 2 * ("even" === t[3] || "odd" === t[3])),
                                t[5] = +(t[7] + t[8] || "odd" === t[3])) : t[3] && tt.error(t[0]),
                                t
                            },
                            PSEUDO: function(t) {
                                var e, n = !t[6] && t[2];
                                return q.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && W.test(n) && (e = ht(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e),
                                t[2] = n.slice(0, e)),
                                t.slice(0, 3))
                            }
                        },
                        filter: {
                            TAG: function(t) {
                                var e = t.replace(U, Y).toLowerCase();
                                return "*" === t ? function() {
                                    return !0
                                }
                                : function(t) {
                            ...
                            CLASS: function(t) {
                                var e = x[t + " "];
                                return e || (e = new RegExp("(^|" + G + ")" + t + "(" + G + "|$)")) && x(t, (function(t) {
                            ...
                            ATTR: function(t, e, n) {
                                return function(r) {
                                    var i = tt.attr(r, t);
                                    return null == i ? "!=" === e : !e || (i += "",
                                    "=" === e ? i === n : "!=" === e ? i !== n : "^=" === e ? n && 0 === i.indexOf(n) : "*=" === e ? n && i.indexOf(n) > -1 : "$=" === e ? n && i.slice(-n.length) === n : "~=" === e ? (" " + i.replace(V, " ") + " ").indexOf(n) > -1 : "|=" === e && (i === n || i.slice(0, n.length + 1) === n + "-"))
                                }
                            },
                            CHILD: function(t, e, n, r, i) {
                                ...
                                : function(e, n, l) {
                                    var c, u, h, f, p, d = a !== o ? "nextSibling" : "previousSibling", g = e.parentNode, b = s && e.nodeName.toLowerCase(), y = !l && !s, x = !1;
                                    if (g) {
                                        if (a) {
                                            while (d) {
                                                h = e;
                                                while (h = h[d])
                                                    if (s ? I(h, b) : 1 === h.nodeType)
                                                        return !1;
                                        ...
                                        !1 === x)
                                            while (h = ++f && h && h[d] || (x = f = 0) || p.pop())
                                                if ((s ? I(h, b) : 1 === h.nodeType) && ++x && (y && (u = h[m] || (h[m] = {}),
                                                u[t] = [v, x]),
                                                h === e))
                                                    break;
                                        return x -= i,
                            ...
                            PSEUDO: function(t, n) {
                                var r, i = e.pseudos[t] || e.setFilters[t.toLowerCase()] || tt.error("unsupported pseudo: " + t);
                                return i[m] ? i(n) : i.length > 1 ? (r = [t, t, "", n],
                                e.setFilters.hasOwnProperty(t.toLowerCase()) ? nt((function(t, e) {
                                    var r, a = i(t, n), o = a.length;
                                    while (o--)
                                        r = h.call(t, a[o]),
                                        t[r] = !(e[r] = a[o])
                                }
                        ...
                        pseudos: {
                            not: nt((function(t) {
                                var e = []
                                  , n = []
                                  , r = xt(t.replace(j, "$1"));
                                return r[m] ? nt((function(t, e, n, i) {
                                    var a, o = r(t, null, i, []), s = t.length;
                                    while (s--)
                                        (a = o[s]) && (t[s] = !(e[s] = a))
                                }
                                )) : function(t, i, a) {
                            ...
                            lang: nt((function(t) {
                                return F.test(t || "") || tt.error("unsupported lang: " + t),
                                t = t.replace(U, Y).toLowerCase(),
                                function(e) {
                                    var n;
                                    do {
                                        if (n = u ? e.lang : e.getAttribute("xml:lang") || e.getAttribute("lang"))
                            ...
                            focus: function(t) {
                                return t === $() && s.hasFocus() && !!(t.type || t.href || ~t.tabIndex)
                            },
                            enabled: ot(!1),
                            disabled: ot(!0),
                            checked: function(t) {
                                return I(t, "input") && !!t.checked || I(t, "option") && !!t.selected
                            },
                            selected: function(t) {
                            ...
                            button: function(t) {
                                return I(t, "input") && "button" === t.type || I(t, "button")
                            },
                            text: function(t) {
                                var e;
                                return I(t, "input") && "text" === t.type && (null == (e = t.getAttribute("type")) || "text" === e.toLowerCase())
                            },
                            first: st((function() {
                                return [0]
                            }
                    ...
                    function ht(t, n) {
                        ...
                        while (s) {
                            ...
                            s = s.slice(r.length)),
                            e.filter)
                                !(i = q[o].exec(s)) || c[o] && !(i = c[o](i)) || (r = i.shift(),
                                a.push({
                                    value: r,
                                    type: o,
                                    matches: i
                        ...
                        return n ? s.length : s ? tt.error(t) : A(t, l).slice(0)
                    }
                    function ft(t) {
                    ...
                    function bt(t, e, n, r, i, a) {
                        ...
                        i && !i[m] && (i = bt(i, a)),
                        nt((function(a, o, s, l) {
                            var c, u, f, p, d = [], m = [], b = o.length, v = a || gt(e || "*", s.nodeType ? [s] : s, []), y = !t || !a && e ? v : mt(v, d, t, s, l);
                            if (n ? (p = i || (a ? t : b || r) ? [] : o,
                            n(y, p, s, l)) : p = y,
                            r) {
                                c = mt(p, m),
                            ...
                            if (a) {
                                if (i || t) {
                                    ...
                                    u = p.length;
                                    while (u--)
                                        (f = p[u]) && (c = i ? h.call(a, f) : d[u]) > -1 && (a[c] = !(o[c] = f))
                                }
                            } else
                                p = mt(p === o ? p.splice(b, p.length) : p),
                                i ? i(null, o, p, l) : g.apply(o, p)
                        }
                        ))
                    }
                    function vt(t) {
                        for (var n, i, a, o = t.length, s = e.relative[t[0].type], l = s || e.relative[" "], c = s ? 1 : 0, u = pt((function(t) {
                            return t === n
                        }
                        ), l, !0), f = pt((function(t) {
                            return h.call(n, t) > -1
                        }
                        ), l, !0), p = [function(t, e, i) {
                            var a = !s && (i || e != r) || ((n = e).nodeType ? u(t, e, i) : f(t, e, i));
                            return n = null,
                            a
                        }
                        ]; c < o; c++)
                            if (i = e.relative[t[c].type])
                                ...
                                if (i = e.filter[t[c].type].apply(null, t[c].matches),
                                i[m]) {
                                    for (a = ++c; a < o; a++)
                                        if (e.relative[t[a].type])
                                            break;
                                    return bt(c > 1 && dt(p), c > 1 && ft(t.slice(0, c - 1).concat({
                                        value: " " === t[c - 2].type ? "*" : ""
                                    })).replace(j, "$1"), i, c < a && vt(t.slice(c, a)), a < o && vt(t = t.slice(a)), a < o && ft(t))
                                }
                                p.push(i)
                            }
                        return dt(p)
                    ...
                    function yt(t, n) {
                        var i = n.length > 0
                          , a = t.length > 0
                          , o = function(o, l, c, h, f) {
                            var p, d, m, b = 0, y = "0", x = o && [], A = [], w = r, C = o || a && e.find.TAG("*", f), S = v += null == w ? 1 : Math.random() || .1, k = C.length;
                            for (f && (r = l == s || l || f); y !== k && null != (p = C[y]); y++) {
                                if (a && p) {
                                    d = 0,
                                    l || p.ownerDocument == s || (ct(p),
                                    c = !u);
                                    while (m = t[d++])
                                        if (m(p, l || s, c)) {
                                            g.call(h, p);
                            ...
                            i && y !== b) {
                                ...
                                if (o) {
                                    if (b > 0)
                                        while (y--)
                                            x[y] || A[y] || (A[y] = E.call(h));
                                    A = mt(A)
                                }
                                g.apply(h, A),
                                f && !o && A.length > 0 && b + n.length > 1 && O.uniqueSort(h)
                            }
                            return f && (v = S,
                            r = w),
                            x
                    ...
                    function At(t, n, r, i) {
                        var a, o, s, l, c, h = "function" === typeof t && t, f = !i && ht(t = h.selector || t);
                        if (r = r || [],
                        1 === f.length) {
                            if (o = f[0] = f[0].slice(0),
                            o.length > 2 && "ID" === (s = o[0]).type && 9 === n.nodeType && u && e.relative[o[1].type]) {
                                if (n = (e.find.ID(s.matches[0].replace(U, Y), n) || [])[0],
                                !n)
                                    return r;
                                h && (n = n.parentNode),
                                t = t.slice(o.shift().value.length)
                            }
                            a = q.needsContext.test(t) ? 0 : o.length;
                            while (a--) {
                                if (s = o[a],
                                e.relative[l = s.type])
                                    break;
                                if ((c = e.find[l]) && (i = c(s.matches[0].replace(U, Y), J.test(o[0].type) && lt(n.parentNode) || n))) {
                                    if (o.splice(a, 1),
                                    t = i.length && ft(o),
                                    !t)
                                        return g.apply(r, i),
                        ...
                        return (h || xt(t, f))(i, n, !u, r, !n || J.test(t) && lt(n.parentNode) || n),
                        r
                    }
                    ut.prototype = e.filters = e.pseudos,
                    e.setFilters = new ut,
                    b.sortStable = m.split("").sort(S).join("") === m,
                    ct(),
                    b.sortDetached = rt((function(t) {
                    ...
                    tt.select = At,
                    tt.setDocument = ct,
                    tt.escape = O.escapeSelector,
                    tt.getText = O.text,
                    tt.isXML = O.isXMLDoc,
                    tt.selectors = O.expr,
                    tt.support = O.support,
                    tt.uniqueSort = O.uniqueSort
                }
                )();
                ...
                O.filter = function(t, e, n) {
                    var r = e[0];
                    return n && (t = ":not(" + t + ")"),
                    1 === e.length && 1 === r.nodeType ? O.find.matchesSelector(r, t) ? [r] : [] : O.find.matches(t, O.grep(e, (function(t) {
                        return 1 === t.nodeType
                    }
                    )))
                }
                ...
                O.fn.extend({
                    ...
                    is: function(t) {
                        return !!W(this, "string" === typeof t && z.test(t) ? O(t) : t || [], !1).length
                    }
                });
                var F, q = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, X = O.fn.init = function(t, e, n) {
                    var r, i;
                    if (!t)
                        return this;
                    if (n = n || F,
                    "string" === typeof t) {
                        if (r = "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [null, t, null] : q.exec(t),
                        !r || !r[1] && e)
                            return !e || e.jquery ? (e || n).find(t) : this.constructor(e).find(t);
                        if (r[1]) {
                            if (e = e instanceof O ? e[0] : e,
                            O.merge(this, O.parseHTML(r[1], e && e.nodeType ? e.ownerDocument || e : x, !0)),
                            Q.test(r[1]) && O.isPlainObject(e))
                                for (r in e)
                    ...
                    this.length = 1,
                    this) : v(t) ? void 0 !== n.ready ? n.ready(t) : t(O) : O.makeArray(t, this)
                }
                ;
                X.prototype = O.fn,
                F = O(x);
                ...
                O.fn.extend({
                    ...
                    closest: function(t, e) {
                        var n, r = 0, i = this.length, a = [], o = "string" !== typeof t && O(t);
                        if (!z.test(t))
                            for (; r < i; r++)
                                for (n = this[r]; n && n !== e; n = n.parentNode)
                                    if (n.nodeType < 11 && (o ? o.index(n) > -1 : 1 === n.nodeType && O.find.matchesSelector(n, t))) {
                                        a.push(n);
                                        break
                                    }
                    ...
                    index: function(t) {
                        return t ? "string" === typeof t ? h.call(O(t), this[0]) : h.call(this, t.jquery ? t[0] : t) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1
                    },
                    add: function(t, e) {
                ...
                O.each({
                    ...
                    contents: function(t) {
                        return null != t.contentDocument && s(t.contentDocument) ? t.contentDocument : (I(t, "template") && (t = t.content || t),
                    ...
                    O.fn[t] = function(n, r) {
                        ...
                        this.length > 1 && (Z[t] || O.uniqueSort(i),
                        H.test(t) && i.reverse()),
                        this.pushStack(i)
                    }
                }
                ...
                function Y(t) {
                    var e = {};
                    return O.each(t.match(U) || [], (function(t, n) {
                        e[n] = !0
                    }
                    )),
                    e
                ...
                O.Callbacks = function(t) {
                    t = "string" === typeof t ? Y(t) : O.extend({}, t);
                    var e, n, r, i, a = [], o = [], s = -1, l = function() {
                        for (i = i || t.once,
                        r = e = !0; o.length; s = -1) {
                            n = o.shift();
                            while (++s < a.length)
                        ...
                        add: function() {
                            ...
                            function e(n) {
                                O.each(n, (function(n, r) {
                                    v(r) ? t.unique && c.has(r) || a.push(r) : r && r.length && "string" !== C(r) && e(r)
                                }
                                ))
                            }(arguments),
                            n && !e && l()),
                        ...
                        has: function(t) {
                            return t ? O.inArray(t, a) > -1 : a.length > 0
                        },
                        empty: function() {
                            return a && (a = []),
                            this
                ...
                O.extend({
                    Deferred: function(t) {
                        var e = [["notify", "progress", O.Callbacks("memory"), O.Callbacks("memory"), 2], ["resolve", "done", O.Callbacks("once memory"), O.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", O.Callbacks("once memory"), O.Callbacks("once memory"), 1, "rejected"]]
                          , r = "pending"
                          , i = {
                            state: function() {
                                return r
                            ...
                            then: function(t, r, i) {
                                ...
                                function o(t, e, r, i) {
                                    return function() {
                                        var s = this
                                          ...
                                          , c = function() {
                                            ...
                                            if (!(t < a)) {
                                                ...
                                                v(c) ? i ? c.call(n, o(a, e, K, i), o(a, e, _, i)) : (a++,
                                                c.call(n, o(a, e, K, i), o(a, e, _, i), o(a, e, K, e.notifyWith))) : (r !== K && (s = void 0,
                                                l = [n]),
                                                (i || e.resolveWith)(s, l))
                                            }
                                        }
                                          , u = i ? c : function() {
                                            try {
                                                ...
                                                O.Deferred.exceptionHook && O.Deferred.exceptionHook(n, u.error),
                                                t + 1 >= a && (r !== _ && (s = void 0,
                                                l = [n]),
                                                e.rejectWith(s, l))
                                            }
                                        ...
                                        ;
                                        t ? u() : (O.Deferred.getErrorHook ? u.error = O.Deferred.getErrorHook() : O.Deferred.getStackHook && (u.error = O.Deferred.getStackHook()),
                                        n.setTimeout(u))
                                    }
                                }
                                return O.Deferred((function(n) {
                                    e[0][3].add(o(0, n, v(i) ? i : K, n.notifyWith)),
                                    e[1][3].add(o(0, n, v(t) ? t : K)),
                                    e[2][3].add(o(0, n, v(r) ? r : _))
                                }
                                )).promise()
                            },
                            promise: function(t) {
                    ...
                    when: function(t) {
                        ...
                        if (e <= 1 && ($(t, a.done(o(n)).resolve, a.reject, !e),
                ...
                var et = O.Deferred();
                function nt() {
                    x.removeEventListener("DOMContentLoaded", nt),
                    n.removeEventListener("load", nt),
                    O.ready()
                }
                ...
                O.extend({
                    ...
                    readyWait: 1,
                    ready: function(t) {
                        (!0 === t ? --O.readyWait : O.isReady) || (O.isReady = !0,
                        !0 !== t && --O.readyWait > 0 || et.resolveWith(x, [O]))
                    }
                }),
                O.ready.then = et.then,
                "complete" === x.readyState || "loading" !== x.readyState && !x.documentElement.doScroll ? n.setTimeout(O.ready) : (x.addEventListener("DOMContentLoaded", nt),
                n.addEventListener("load", nt));
                var rt = function(t, e, n, r, i, a, o) {
                    var s = 0
                      , l = t.length
                      , c = null == n;
                    if ("object" === C(n))
                ...
                function st(t) {
                    return t.replace(it, "ms-").replace(at, ot)
                }
                var lt = function(t) {
                    return 1 === t.nodeType || 9 === t.nodeType || !+t.nodeType
                };
                function ct() {
                    this.expando = O.expando + ct.uid++
                }
                ct.uid = 1,
                ct.prototype = {
                    cache: function(t) {
                    ...
                    get: function(t, e) {
                        return void 0 === e ? this.cache(t) : t[this.expando] && t[this.expando][st(e)]
                    },
                    ...
                    remove: function(t, e) {
                        ...
                        if (void 0 !== r) {
                            if (void 0 !== e) {
                                Array.isArray(e) ? e = e.map(st) : (e = st(e),
                                e = e in r ? [e] : e.match(U) || []),
                                n = e.length;
                                while (n--)
                                    delete r[e[n]]
                            }
                ...
                function gt(t, e, n) {
                    ...
                    if (void 0 === n && 1 === t.nodeType)
                        if (r = "data-" + e.replace(pt, "-$&").toLowerCase(),
                        n = t.getAttribute(r),
                        "string" === typeof n) {
                            try {
                                n = dt(n)
                ...
                O.fn.extend({
                    data: function(t, e) {
                        ...
                        if (void 0 === t) {
                            if (this.length && (i = ht.get(a),
                            1 === a.nodeType && !ut.get(a, "hasDataAttrs"))) {
                                n = o.length;
                                while (n--)
                                    o[n] && (r = o[n].name,
                                    0 === r.indexOf("data-") && (r = st(r.slice(5)),
                                    gt(a, r, i[r])));
                                ut.set(a, "hasDataAttrs", !0)
                            }
                            return i
                        }
                ...
                O.extend({
                    queue: function(t, e, n) {
                        ...
                        if (t)
                            return e = (e || "fx") + "queue",
                            r = ut.get(t, e),
                            n && (!r || Array.isArray(n) ? r = ut.access(t, e, O.makeArray(n)) : r.push(n)),
                            r || []
                    },
                ...
                O.fn.extend({
                    queue: function(t, e) {
                        ...
                        t = "fx",
                        n--),
                        arguments.length < n ? O.queue(this[0], t) : void 0 === e ? this : this.each((function() {
                    ...
                    promise: function(t, e) {
                        var n, r = 1, i = O.Deferred(), a = this, o = this.length, s = function() {
                            --r || i.resolveWith(a, [a])
                        };
                        "string" !== typeof t && (e = t,
                        t = void 0),
                ...
                yt.getRootNode && (xt = function(t) {
                    return O.contains(t.ownerDocument, t) || t.getRootNode(At) === t.ownerDocument
                }
                );
                var wt = function(t, e) {
                    return t = e || t,
                    "none" === t.style.display || "" === t.style.display && xt(t) && "none" === O.css(t, "display")
                };
                function Ct(t, e, n, r) {
                    ...
                    , l = s(), c = n && n[3] || (O.cssNumber[e] ? "" : "px"), u = t.nodeType && (O.cssNumber[e] || "px" !== c && +l) && bt.exec(O.css(t, e));
                    if (u && u[3] !== c) {
                        l /= 2,
                        c = c || u[3],
                        u = +l || 1;
                ...
                var St = {};
                function kt(t) {
                    var e, n = t.ownerDocument, r = t.nodeName, i = St[r];
                ...
                function Ot(t, e) {
                    for (var n, r, i = [], a = 0, o = t.length; a < o; a++)
                        ...
                        e ? ("none" === n && (i[a] = ut.get(r, "display") || null,
                        i[a] || (r.style.display = "")),
                        "" === r.style.display && wt(r) && (i[a] = kt(r))) : "none" !== n && (i[a] = "none",
                        ut.set(r, "display", n)));
                    for (a = 0; a < o; a++)
                ...
                O.fn.extend({
                    ...
                    toggle: function(t) {
                        return "boolean" === typeof t ? t ? this.show() : this.hide() : this.each((function() {
                            wt(this) ? O(this).show() : O(this).hide()
                        }
                        ))
                    }
                });
                ...
                function Lt(t, e) {
                    ...
                    void 0 === e || e && I(t, e) ? O.merge([t], n) : n
                }
                function Gt(t, e) {
                ...
                function Nt(t, e, n, r, i) {
                    for (var a, o, s, l, c, u, h = e.createDocumentFragment(), f = [], p = 0, d = t.length; p < d; p++)
                        if (a = t[p],
                        a || 0 === a)
                            if ("object" === C(a))
                                O.merge(f, a.nodeType ? [a] : a);
                            else if (jt.test(a)) {
                                o = o || h.appendChild(e.createElement("div")),
                                s = (It.exec(a) || ["", ""])[1].toLowerCase(),
                                l = Dt[s] || Dt._default,
                                o.innerHTML = l[1] + O.htmlPrefilter(a) + l[2],
                                u = l[0];
                                while (u--)
                                    o = o.lastChild;
                                O.merge(f, o.childNodes),
                                o = h.firstChild,
                                o.textContent = ""
                            } else
                    ...
                    O.event.add(t, e, {
                        ...
                        handler: function(t) {
                            ...
                            if (1 & t.isTrigger && this[e]) {
                                if (r)
                                    (O.event.special[e] || {}).delegateType && t.stopPropagation();
                                ...
                                r && (ut.set(this, e, O.event.trigger(r[0], r.slice(1), this)),
                                t.stopPropagation(),
                                t.isImmediatePropagationStopped = Rt)
                        }
                    })) : void 0 === ut.get(t, e) && O.event.add(t, e, Rt)
                }
                O.event = {
                    global: {},
                    add: function(t, e, n, r, i) {
                        var a, o, s, l, c, u, h, f, p, d, g, m = ut.get(t);
                        if (lt(t)) {
                            n.handler && (a = n,
                            n = a.handler,
                            i = a.selector),
                            i && O.find.matchesSelector(yt, i),
                            n.guid || (n.guid = O.guid++),
                            (l = m.events) || (l = m.events = Object.create(null)),
                            (o = m.handle) || (o = m.handle = function(e) {
                                return "undefined" !== typeof O && O.event.triggered !== e.type ? O.event.dispatch.apply(t, arguments) : void 0
                            }
                            ),
                            e = (e || "").match(U) || [""],
                            c = e.length;
                            while (c--)
                                ...
                                (f = l[p]) || (f = l[p] = [],
                                f.delegateCount = 0,
                                h.setup && !1 !== h.setup.call(t, r, d, o) || t.addEventListener && t.addEventListener(p, o)),
                    ...
                    remove: function(t, e, n, r, i) {
                        var a, o, s, l, c, u, h, f, p, d, g, m = ut.hasData(t) && ut.get(t);
                        if (m && (l = m.events)) {
                            e = (e || "").match(U) || [""],
                            c = e.length;
                            while (c--)
                                ...
                                p) {
                                    ...
                                    while (a--)
                                        u = f[a],
                                        !i && g !== u.origType || n && n.guid !== u.guid || s && !s.test(u.namespace) || r && r !== u.selector && ("**" !== r || !u.selector) || (f.splice(a, 1),
                                        u.selector && f.delegateCount--,
                                        h.remove && h.remove.call(t, u));
                                    o && !f.length && (h.teardown && !1 !== h.teardown.call(t, d, m.handle) || O.removeEvent(t, p, m.handle),
                                    delete l[p])
                                } else
                                    for (p in l)
                                        O.event.remove(t, p + e[c], n, r, !0);
                            O.isEmptyObject(l) && ut.remove(t, "handle events")
                        }
                    },
                    dispatch: function(t) {
                        var e, n, r, i, a, o, s = new Array(arguments.length), l = O.event.fix(t), c = (ut.get(this, "events") || Object.create(null))[l.type] || [], u = O.event.special[l.type] || {};
                        for (s[0] = l,
                        e = 1; e < arguments.length; e++)
                            s[e] = arguments[e];
                        if (l.delegateTarget = this,
                        !u.preDispatch || !1 !== u.preDispatch.call(this, l)) {
                            o = O.event.handlers.call(this, l, c),
                            e = 0;
                            while ((i = o[e++]) && !l.isPropagationStopped()) {
                                l.currentTarget = i.elem,
                                n = 0;
                                while ((a = i.handlers[n++]) && !l.isImmediatePropagationStopped())
                                    l.rnamespace && !1 !== a.namespace && !l.rnamespace.test(a.namespace) || (l.handleObj = a,
                                    l.data = a.data,
                                    r = ((O.event.special[a.origType] || {}).handle || a.handler).apply(i.elem, s),
                                    void 0 !== r && !1 === (l.result = r) && (l.preventDefault(),
                                    l.stopPropagation()))
                            }
                    ...
                    handlers: function(t, e) {
                        var n, r, i, a, o, s = [], l = e.delegateCount, c = t.target;
                            ...
                            for (; c !== this; c = c.parentNode || this)
                                if (1 === c.nodeType && ("click" !== t.type || !0 !== c.disabled)) {
                                    ...
                                    n = 0; n < l; n++)
                                        r = e[n],
                                        i = r.selector + " ",
                                        void 0 === o[i] && (o[i] = r.needsContext ? O(i, this).index(c) > -1 : O.find(i, this, null, [c]).length),
                                        o[i] && a.push(r);
                                    a.length && s.push({
                                        elem: c,
                                        handlers: a
                    ...
                    special: {
                        ...
                        click: {
                            setup: function(t) {
                                var e = this || t;
                                return Tt.test(e.type) && e.click && I(e, "input") && Pt(e, "click", !0),
                                !1
                            },
                            trigger: function(t) {
                                var e = this || t;
                                return Tt.test(e.type) && e.click && I(e, "input") && Pt(e, "click"),
                                !0
                            },
                            _default: function(t) {
                                var e = t.target;
                                return Tt.test(e.type) && e.click && I(e, "input") && ut.get(e, "click") || I(e, "a")
                            }
                        },
                        beforeunload: {
                ...
                O.Event = function(t, e) {
                    if (!(this instanceof O.Event))
                        return new O.Event(t,e);
                    t && t.type ? (this.originalEvent = t,
                    this.type = t.type,
                    this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? Rt : Bt,
                    ...
                    O.event.special[t] = {
                        ...
                        teardown: function() {
                            ...
                            if (!x.documentMode)
                                return !1;
                            t = ut.get(this, e) - 1,
                            t ? ut.set(this, e, t) : (this.removeEventListener(e, n),
                            ut.remove(this, e))
                        },
                        _default: function(e) {
                    ...
                    O.event.special[e] = {
                        ...
                        teardown: function() {
                            var r = this.ownerDocument || this.document || this
                              , i = x.documentMode ? this : r
                              , a = ut.get(i, e) - 1;
                            a ? ut.set(i, e, a) : (x.documentMode ? this.removeEventListener(e, n) : r.removeEventListener(t, n, !0),
                            ut.remove(i, e))
                        }
                    }
                }
                ...
                O.each({
                    ...
                    O.event.special[t] = {
                        ...
                        bindType: e,
                        handle: function(t) {
                            var n, r = this, i = t.relatedTarget, a = t.handleObj;
                            return i && (i === r || O.contains(r, i)) || (t.type = a.origType,
                ...
                O.fn.extend({
                    on: function(t, e, n, r) {
                        return Vt(this, t, e, n, r)
                    },
                    one: function(t, e, n, r) {
                        return Vt(this, t, e, n, r, 1)
                    },
                    off: function(t, e, n) {
                        var r, i;
                        if (t && t.preventDefault && t.handleObj)
                            return r = t.handleObj,
                            O(t.delegateTarget).off(r.namespace ? r.origType + "." + r.namespace : r.origType, r.selector, r.handler),
                            this;
                        if ("object" === typeof t) {
                            for (i in t)
                                this.off(i, e, t[i]);
                ...
                var zt = /<script|<style|<link/i
                  ...
                  , Wt = /^\s*<!\[CDATA\[|\]\]>\s*$/g;
                function Ft(t, e) {
                    return I(t, "table") && I(11 !== e.nodeType ? e : e.firstChild, "tr") && O(t).children("tbody")[0] || t
                }
                function qt(t) {
                    ...
                    if (1 === e.nodeType) {
                        ...
                        l))
                            ...
                            l)
                                for (n = 0,
                                r = l[i].length; n < r; n++)
                                    O.event.add(e, i, l[i][n]);
                        ht.hasData(t) && (o = ht.access(t),
                        s = O.extend({}, o),
                        ht.set(e, s))
                    }
                }
                ...
                function Jt(t, e, n, r) {
                    e = c(e);
                    var i, a, o, s, l, u, h = 0, f = t.length, p = f - 1, d = e[0], g = v(d);
                    if (g || f > 1 && "string" === typeof d && !b.checkClone && Qt.test(d))
                        return t.each((function(i) {
                            var a = t.eq(i);
                            g && (e[0] = d.call(this, i, a.html())),
                            Jt(a, e, n, r)
                        }
                        ));
                    if (f && (i = Nt(e, t[0].ownerDocument, !1, t, r),
                    a = i.firstChild,
                    1 === i.childNodes.length && (i = a),
                    a || r)) {
                        for (o = O.map(Lt(i, "script"), qt),
                        s = o.length; h < f; h++)
                            l = i,
                            h !== p && (l = O.clone(l, !0, !0),
                            s && O.merge(o, Lt(l, "script"))),
                            n.call(t[h], l, h);
                        if (s)
                            ...
                            h = 0; h < s; h++)
                                l = o[h],
                                Et.test(l.type || "") && !ut.access(l, "globalEval") && O.contains(u, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? O._evalUrl && !l.noModule && O._evalUrl(l.src, {
                                    nonce: l.nonce || l.getAttribute("nonce")
                                }, u) : w(l.textContent.replace(Wt, ""), l, u))
                    }
                    return t
                }
                function Ut(t, e, n) {
                    for (var r, i = e ? O.filter(e, t) : t, a = 0; null != (r = i[a]); a++)
                        n || 1 !== r.nodeType || O.cleanData(Lt(r)),
                        r.parentNode && (n && xt(r) && Gt(Lt(r, "script")),
                ...
                O.extend({
                    ...
                    clone: function(t, e, n) {
                        var r, i, a, o, s = t.cloneNode(!0), l = xt(t);
                        if (!b.noCloneChecked && (1 === t.nodeType || 11 === t.nodeType) && !O.isXMLDoc(t))
                            for (o = Lt(s),
                            a = Lt(t),
                            r = 0,
                            i = a.length; r < i; r++)
                        ...
                        if (e)
                            if (n)
                                ...
                                Ht(t, s);
                        return o = Lt(s, "script"),
                        o.length > 0 && Gt(o, !l && Lt(t, "script")),
                        s
                    },
                    cleanData: function(t) {
                        for (var e, n, r, i = O.event.special, a = 0; void 0 !== (n = t[a]); a++)
                            if (lt(n)) {
                                if (e = n[ut.expando]) {
                                    if (e.events)
                                        for (r in e.events)
                ...
                O.fn.extend({
                    ...
                    empty: function() {
                        for (var t, e = 0; null != (t = this[e]); e++)
                            1 === t.nodeType && (O.cleanData(Lt(t, !1)),
                            t.textContent = "");
                        return this
                    },
                    clone: function(t, e) {
                    ...
                    html: function(t) {
                        return rt(this, (function(t) {
                            ...
                            if (void 0 === t && 1 === e.nodeType)
                                return e.innerHTML;
                            if ("string" === typeof t && !zt.test(t) && !Dt[(It.exec(t) || ["", ""])[1].toLowerCase()]) {
                                t = O.htmlPrefilter(t);
                                try {
                                    for (; n < r; n++)
                                        e = this[n] || {},
                                        1 === e.nodeType && (O.cleanData(Lt(e, !1)),
                                        e.innerHTML = t);
                                    e = 0
                                } catch (i) {}
                            }
                    ...
                    replaceWith: function() {
                        ...
                        return Jt(this, arguments, (function(e) {
                            ...
                            O.inArray(this, t) < 0 && (O.cleanData(Lt(this)),
                ...
                O.each({
                    ...
                    O.fn[t] = function(t) {
                        for (var n, r = [], i = O(t), a = i.length - 1, o = 0; o <= a; o++)
                ...
                var Yt = new RegExp("^(" + mt + ")(?!px)[a-z%]+$","i")
                  ...
                  , te = new RegExp(vt.join("|"),"i");
                function ee(t, e, n) {
                    var r, i, a, o, s = Kt.test(e), l = t.style;
                    return n = n || _t(t),
                    n && (o = n.getPropertyValue(e) || n[e],
                    s && o && (o = o.replace(j, "$1") || void 0),
                    "" !== o || xt(t) || (o = O.style(t, e)),
                    !b.pixelBoxStyles() && Yt.test(o) && te.test(e) && (r = l.width,
                    i = l.minWidth,
                    a = l.maxWidth,
                ...
                (function() {
                    function t() {
                        if (u) {
                            ...
                            yt.appendChild(c).appendChild(u);
                    ...
                    var r, i, a, o, s, l, c = x.createElement("div"), u = x.createElement("div");
                ...
                function se(t) {
                    var e = O.cssProps[t] || ae[t];
                    return e || (t in ie ? t : ae[t] = oe(t) || t)
                }
                ...
                function fe(t, e, n, r, i, a) {
                    ...
                    if (n === (r ? "border" : "content"))
                        return 0;
                    for (; o < 4; o += 2)
                        "margin" === n && (c += O.css(t, n + vt[o], !0, i)),
                        r ? ("content" === n && (l -= O.css(t, "padding" + vt[o], !0, i)),
                        "margin" !== n && (l -= O.css(t, "border" + vt[o] + "Width", !0, i))) : (l += O.css(t, "padding" + vt[o], !0, i),
                        "padding" !== n ? l += O.css(t, "border" + vt[o] + "Width", !0, i) : s += O.css(t, "border" + vt[o] + "Width", !0, i));
                    return !r && a >= 0 && (l += Math.max(0, Math.ceil(t["offset" + e[0].toUpperCase() + e.slice(1)] - a - l - s - .5)) || 0),
                    l + c
                }
                function pe(t, e, n) {
                    var r = _t(t)
                      , i = !b.boxSizingReliable() || n
                      , a = i && "border-box" === O.css(t, "boxSizing", !1, r)
                      , o = a
                      , s = ee(t, e, r)
                    ...
                    return (!b.boxSizingReliable() && a || !b.reliableTrDimensions() && I(t, "tr") || "auto" === s || !parseFloat(s) && "inline" === O.css(t, "display", !1, r)) && t.getClientRects().length && (a = "border-box" === O.css(t, "boxSizing", !1, r),
                    o = l in t,
                    o && (s = t[l])),
                    s = parseFloat(s) || 0,
                    s + fe(t, e, n || (a ? "border" : "content"), o, r, s) + "px"
                }
                ...
                O.extend({
                    ...
                    style: function(t, e, n, r) {
                        if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                            var i, a, o, s = st(e), l = Kt.test(e), c = t.style;
                            if (l || (e = se(s)),
                            o = O.cssHooks[e] || O.cssHooks[s],
                            void 0 === n)
                                return o && "get"in o && void 0 !== (i = o.get(t, !1, r)) ? i : c[e];
                            a = typeof n,
                            "string" === a && (i = bt.exec(n)) && i[1] && (n = Ct(t, e, i),
                            a = "number"),
                            null != n && n === n && ("number" !== a || l || (n += i && i[3] || (O.cssNumber[s] ? "" : "px")),
                            b.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (c[e] = "inherit"),
                            o && "set"in o && void 0 === (n = o.set(t, n, r)) || (l ? c.setProperty(e, n) : c[e] = n))
                        }
                    },
                    css: function(t, e, n, r) {
                        var i, a, o, s = st(e), l = Kt.test(e);
                        return l || (e = se(s)),
                        o = O.cssHooks[e] || O.cssHooks[s],
                        o && "get"in o && (i = o.get(t, !0, n)),
                        void 0 === i && (i = ee(t, e, r)),
                ...
                O.each(["height", "width"], (function(t, e) {
                    O.cssHooks[e] = {
                        get: function(t, n, r) {
                            if (n)
                                return !le.test(O.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? pe(t, e, r) : $t(t, ce, (function() {
                                    return pe(t, e, r)
                                }
                                ))
                        },
                        set: function(t, n, r) {
                            var i, a = _t(t), o = !b.scrollboxSize() && "absolute" === a.position, s = o || r, l = s && "border-box" === O.css(t, "boxSizing", !1, a), c = r ? fe(t, e, r, l, a) : 0;
                            return l && o && (c -= Math.ceil(t["offset" + e[0].toUpperCase() + e.slice(1)] - parseFloat(a[e]) - fe(t, e, "border", !1, a) - .5)),
                            c && (i = bt.exec(n)) && "px" !== (i[3] || "px") && (t.style[e] = n,
                            n = O.css(t, e)),
                            he(t, n, c)
                        }
                    }
                ...
                O.cssHooks.marginLeft = ne(b.reliableMarginLeft, (function(t, e) {
                    if (e)
                        return (parseFloat(ee(t, "marginLeft")) || t.getBoundingClientRect().left - $t(t, {
                            marginLeft: 0
                        }, (function() {
                    ...
                    O.cssHooks[t + e] = {
                        expand: function(n) {
                            for (var r = 0, i = {}, a = "string" === typeof n ? n.split(" ") : [n]; r < 4; r++)
                                i[t + vt[r] + e] = a[r] || a[r - 2] || a[0];
                            return i
                        }
                    },
                    "margin" !== t && (O.cssHooks[t + e].set = he)
                }
                )),
                O.fn.extend({
                    css: function(t, e) {
                ...
                de.prototype = {
                    ...
                    run: function(t) {
                        ...
                        return this.options.duration ? this.pos = e = O.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : this.pos = e = t,
                ...
                de.propHooks = {
                    _default: {
                        get: function(t) {
                            var e;
                            return 1 !== t.elem.nodeType || null != t.elem[t.prop] && null == t.elem.style[t.prop] ? t.elem[t.prop] : (e = O.css(t.elem, t.prop, ""),
                            e && "auto" !== e ? e : 0)
                        },
                        set: function(t) {
                            O.fx.step[t.prop] ? O.fx.step[t.prop](t) : 1 !== t.elem.nodeType || !O.cssHooks[t.prop] && null == t.elem.style[se(t.prop)] ? t.elem[t.prop] = t.now : O.style(t.elem, t.prop, t.now + t.unit)
                        }
                    }
                },
                ...
                O.fx.step = {};
                var ge, me, be = /^(?:toggle|show|hide)$/, ve = /queueHooks$/;
                function ye() {
                    me && (!1 === x.hidden && n.requestAnimationFrame ? n.requestAnimationFrame(ye) : n.setTimeout(ye, O.fx.interval),
                    O.fx.tick())
                }
                function xe() {
                ...
                function we(t, e, n) {
                    for (var r, i = (ke.tweeners[e] || []).concat(ke.tweeners["*"]), a = 0, o = i.length; a < o; a++)
                        if (r = i[a].call(n, e, t))
                            return r
                }
                function Ce(t, e, n) {
                    var r, i, a, o, s, l, c, u, h = "width"in e || "height"in e, f = this, p = {}, d = t.style, g = t.nodeType && wt(t), m = ut.get(t, "fxshow");
                    for (r in n.queue || (o = O._queueHooks(t, "fx"),
                    ...
                    f.always((function() {
                        f.always((function() {
                            o.unqueued--,
                            O.queue(t, "fx").length || o.empty.fire()
                        }
                        ))
                    }
                    ))),
                    e)
                        ...
                        be.test(i)) {
                            ...
                            p[r] = m && m[r] || O.style(t, r)
                        }
                    if (l = !O.isEmptyObject(e),
                    l || !O.isEmptyObject(p))
                        for (r in h && 1 === t.nodeType && (n.overflow = [d.overflow, d.overflowX, d.overflowY],
                        c = m && m.display,
                        null == c && (c = ut.get(t, "display")),
                        u = O.css(t, "display"),
                        "none" === u && (c ? u = c : (Ot([t], !0),
                        c = t.style.display || c,
                        u = O.css(t, "display"),
                        Ot([t]))),
                        ("inline" === u || "inline-block" === u && null != c) && "none" === O.css(t, "float") && (l || (f.done((function() {
                            d.display = c
                        }
                        )),
                        null == c && (u = d.display,
                        ...
                        l = !1,
                        p)
                            l || (m ? "hidden"in m && (g = m.hidden) : m = ut.access(t, "fxshow", {
                                display: c
                            }),
                            a && (m.hidden = !g),
                            g && Ot([t], !0),
                ...
                function ke(t, e, n) {
                    var r, i, a = 0, o = ke.prefilters.length, s = O.Deferred().always((function() {
                        delete l.elem
                    }
                    )), l = function() {
                        if (i)
                            return !1;
                        for (var e = ge || xe(), n = Math.max(0, c.startTime + c.duration - e), r = n / c.duration || 0, a = 1 - r, o = 0, l = c.tweens.length; o < l; o++)
                            c.tweens[o].run(a);
                        return s.notifyWith(t, [c, a, n]),
                        a < 1 && l ? n : (l || s.notifyWith(t, [c, 1, 0]),
                        s.resolveWith(t, [c]),
                        !1)
                    }, c = s.promise({
                        elem: t,
                        ...
                        createTween: function(e, n) {
                            var r = O.Tween(t, c.opts, e, n, c.opts.specialEasing[e] || c.opts.easing);
                    ...
                    for (Se(u, c.opts.specialEasing); a < o; a++)
                        if (r = ke.prefilters[a].call(c, t, u, c.opts),
                        r)
                            return v(r.stop) && (O._queueHooks(c.elem, c.opts.queue).stop = r.stop.bind(r)),
                            r;
                    return O.map(u, we, c),
                    v(c.opts.start) && c.opts.start.call(t, c),
                    c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always),
                    O.fx.timer(O.extend(l, {
                        elem: t,
                        anim: c,
                        queue: c.opts.queue
                    })),
                ...
                O.Animation = O.extend(ke, {
                    tweeners: {
                        "*": [function(t, e) {
                            ...
                            return Ct(n.elem, t, bt.exec(e), n),
                            n
                        }
                        ]
                    },
                ...
                O.speed = function(t, e, n) {
                    var r = t && "object" === typeof t ? O.extend({}, t) : {
                        complete: n || !n && e || v(t) && t,
                        duration: t,
                        easing: n && e || e && !v(e) && e
                    };
                    return O.fx.off ? r.duration = 0 : "number" !== typeof r.duration && (r.duration in O.fx.speeds ? r.duration = O.fx.speeds[r.duration] : r.duration = O.fx.speeds._default),
                ...
                O.fn.extend({
                    ...
                    finish: function(t) {
                        return !1 !== t && (t = t || "fx"),
                        this.each((function() {
                            var e, n = ut.get(this), r = n[t + "queue"], i = n[t + "queueHooks"], a = O.timers, o = r ? r.length : 0;
                            for (n.finish = !0,
                            O.queue(this, t, []),
                ...
                function() {
                    ...
                    t.type = "checkbox",
                    b.checkOn = "" !== t.value,
                    b.optSelected = n.selected,
                    t = x.createElement("input"),
                    t.value = "t",
                    t.type = "radio",
                    b.radioValue = "t" === t.value
                }();
                var Oe, Te = O.expr.attrHandle;
                O.fn.extend({
                    attr: function(t, e) {
                        return rt(this, O.attr, t, e, arguments.length > 1)
                    },
                ...
                O.extend({
                    attr: function(t, e, n) {
                        ...
                        if (3 !== a && 8 !== a && 2 !== a)
                            return "undefined" === typeof t.getAttribute ? O.prop(t, e, n) : (1 === a && O.isXMLDoc(t) || (i = O.attrHooks[e.toLowerCase()] || (O.expr.match.bool.test(e) ? Oe : void 0)),
                            void 0 !== n ? null === n ? void O.removeAttr(t, e) : i && "set"in i && void 0 !== (r = i.set(t, n, e)) ? r : (t.setAttribute(e, n + ""),
                            n) : i && "get"in i && null !== (r = i.get(t, e)) ? r : (r = O.find.attr(t, e),
                            null == r ? void 0 : r))
                    },
                    attrHooks: {
                        type: {
                            set: function(t, e) {
                                if (!b.radioValue && "radio" === e && I(t, "input")) {
                                    var n = t.value;
                ...
                Oe = {
                    set: function(t, e, n) {
                        return !1 === e ? O.removeAttr(t, n) : t.setAttribute(n, n),
                        n
                    }
                },
                O.each(O.expr.match.bool.source.match(/\w+/g), (function(t, e) {
                    var n = Te[e] || O.find.attr;
                    Te[e] = function(t, e, r) {
                ...
                O.fn.extend({
                    prop: function(t, e) {
                        return rt(this, O.prop, t, e, arguments.length > 1)
                    },
                ...
                O.extend({
                    prop: function(t, e, n) {
                        var r, i, a = t.nodeType;
                        if (3 !== a && 8 !== a && 2 !== a)
                            return 1 === a && O.isXMLDoc(t) || (e = O.propFix[e] || e,
                            i = O.propHooks[e]),
                    ...
                    propHooks: {
                        tabIndex: {
                            get: function(t) {
                                ...
                                return e ? parseInt(e, 10) : Ie.test(t.nodeName) || Ee.test(t.nodeName) && t.href ? 0 : -1
                            }
                        }
                    },
                    propFix: {
                ...
                O.fn.extend({
                    addClass: function(t) {
                        ...
                        return v(t) ? this.each((function(e) {
                            O(this).addClass(t.call(this, e, Le(this)))
                        }
                        )) : (e = Ge(t),
                    ...
                    removeClass: function(t) {
                        var e, n, r, i, a, o;
                        return v(t) ? this.each((function(e) {
                            O(this).removeClass(t.call(this, e, Le(this)))
                        }
                        )) : arguments.length ? (e = Ge(t),
                        e.length ? this.each((function() {
                            if (r = Le(this),
                            n = 1 === this.nodeType && " " + De(r) + " ",
                            n) {
                    ...
                    toggleClass: function(t, e) {
                        ...
                        return v(t) ? this.each((function(n) {
                            O(this).toggleClass(t.call(this, n, Le(this), e), e)
                        }
                        )) : "boolean" === typeof e && s ? e ? this.addClass(t) : this.removeClass(t) : (n = Ge(t),
                        this.each((function() {
                            if (s)
                                for (a = O(this),
                                i = 0; i < n.length; i++)
                                ...
                                void 0 !== t && "boolean" !== o || (r = Le(this),
                                r && ut.set(this, "__className__", r),
                    ...
                    hasClass: function(t) {
                        ...
                        e = " " + t + " ";
                        while (n = this[r++])
                            if (1 === n.nodeType && (" " + De(Le(n)) + " ").indexOf(e) > -1)
                                return !0;
                        return !1
                    }
                });
                ...
                O.fn.extend({
                    val: function(t) {
                        ...
                        this.each((function(n) {
                            var i;
                            1 === this.nodeType && (i = r ? t.call(this, n, O(this).val()) : t,
                            null == i ? i = "" : "number" === typeof i ? i += "" : Array.isArray(i) && (i = O.map(i, (function(t) {
                                return null == t ? "" : t + ""
                            }
                            ))),
                            e = O.valHooks[this.type] || O.valHooks[this.nodeName.toLowerCase()],
                            e && "set"in e && void 0 !== e.set(this, i, "value") || (this.value = i))
                        }
                        ))) : i ? (e = O.valHooks[i.type] || O.valHooks[i.nodeName.toLowerCase()],
                    ...
                    valHooks: {
                        option: {
                            get: function(t) {
                                ...
                                return null != e ? e : De(O.text(t))
                            }
                        },
                        select: {
                            get: function(t) {
                                var e, n, r, i = t.options, a = t.selectedIndex, o = "select-one" === t.type, s = o ? null : [], l = o ? a + 1 : i.length;
                                for (r = a < 0 ? l : o ? a : 0; r < l; r++)
                                    if (n = i[r],
                                    (n.selected || r === a) && !n.disabled && (!n.parentNode.disabled || !I(n.parentNode, "optgroup"))) {
                                        if (e = O(n).val(),
                                        o)
                                            return e;
                                        s.push(e)
                            ...
                            set: function(t, e) {
                                var n, r, i = t.options, a = O.makeArray(e), o = i.length;
                                while (o--)
                                    r = i[o],
                                    (r.selected = O.inArray(O.valHooks.option.get(r), a) > -1) && (n = !0);
                ...
                O.each(["radio", "checkbox"], (function() {
                    ...
                    b.checkOn || (O.valHooks[this].get = function(t) {
                ...
                O.parseXML = function(t) {
                    ...
                    e && !r || O.error("Invalid XML: " + (r ? O.map(r.childNodes, (function(t) {
                        return t.textContent
                    }
                    )).join("\n") : t)),
                    e
                ...
                O.extend(O.event, {
                    trigger: function(t, e, r, i) {
                        var a, o, s, l, c, u, h, f, p = [r || x], g = d.call(t, "type") ? t.type : t, m = d.call(t, "namespace") ? t.namespace.split(".") : [];
                        if (o = f = s = r = r || x,
                        3 !== r.nodeType && 8 !== r.nodeType && !Be.test(g + O.event.triggered) && (g.indexOf(".") > -1 && (m = g.split("."),
                        g = m.shift(),
                        m.sort()),
                        c = g.indexOf(":") < 0 && "on" + g,
                        t = t[O.expando] ? t : new O.Event(g,"object" === typeof t && t),
                        t.isTrigger = i ? 2 : 3,
                        t.namespace = m.join("."),
                        ...
                        i || !h.trigger || !1 !== h.trigger.apply(r, e))) {
                            if (!i && !h.noBubble && !y(r)) {
                                ...
                                Be.test(l + g) || (o = o.parentNode); o; o = o.parentNode)
                                    p.push(o),
                                    s = o;
                                s === (r.ownerDocument || x) && p.push(s.defaultView || s.parentWindow || n)
                            }
                            a = 0;
                            while ((o = p[a++]) && !t.isPropagationStopped())
                                f = o,
                                t.type = a > 1 ? l : h.bindType || g,
                                u = (ut.get(o, "events") || Object.create(null))[t.type] && ut.get(o, "handle"),
                                u && u.apply(o, e),
                                u = c && o[c],
                                u && u.apply && lt(o) && (t.result = u.apply(o, e),
                                !1 === t.result && t.preventDefault());
                            return t.type = g,
                            i || t.isDefaultPrevented() || h._default && !1 !== h._default.apply(p.pop(), e) || !lt(r) || c && v(r[g]) && !y(r) && (s = r[c],
                            s && (r[c] = null),
                            O.event.triggered = g,
                            t.isPropagationStopped() && f.addEventListener(g, Ve),
                            r[g](),
                            t.isPropagationStopped() && f.removeEventListener(g, Ve),
                ...
                O.fn.extend({
                    ...
                    triggerHandler: function(t, e) {
                        var n = this[0];
                        if (n)
                            return O.event.trigger(t, e, n, !0)
                    }
                });
                var Pe = /\[\]$/
                  , ze = /\r?\n/g
                ...
                function Fe(t, e, n, r) {
                    ...
                    if (Array.isArray(e))
                        O.each(e, (function(e, i) {
                            n || Pe.test(t) ? r(t, i) : Fe(t + "[" + ("object" === typeof i && null != i ? e : "") + "]", i, n, r)
                        }
                        ));
                ...
                O.fn.extend({
                    ...
                    serializeArray: function() {
                        return this.map((function() {
                            ...
                            var t = this.type;
                            return this.name && !O(this).is(":disabled") && We.test(this.nodeName) && !Qe.test(t) && (this.checked || !Tt.test(t))
                        }
                        )).map((function(t, e) {
                            var n = O(this).val();
                            return null == n ? null : Array.isArray(n) ? O.map(n, (function(t) {
                                return {
                                    name: e.name,
                                    value: t.replace(ze, "\r\n")
                                }
                ...
                function nn(t, e, n, r) {
                    ...
                    function o(s) {
                        var l;
                        return i[s] = !0,
                        O.each(t[s] || [], (function(t, s) {
                            var c = s(e, n, r);
                            return "string" !== typeof c || a || i[c] ? a ? !(l = c) : void 0 : (e.dataTypes.unshift(c),
                            o(c),
                            !1)
                        }
                        )),
                ...
                function rn(t, e) {
                    ...
                    return r && O.extend(!0, t, r),
                    t
                }
                function an(t, e, n) {
                    var r, i, a, o, s = t.contents, l = t.dataTypes;
                    while ("*" === l[0])
                        l.shift(),
                ...
                function on(t, e, n, r) {
                    var i, a, o, s, l, c = {}, u = t.dataTypes.slice();
                    if (u[1])
                ...
                O.extend({
                    ...
                    ajaxSetup: function(t, e) {
                        return e ? rn(rn(t, O.ajaxSettings), e) : rn(O.ajaxSettings, t)
                    },
                    ajaxPrefilter: en(Ke),
                    ajaxTransport: en(_e),
                    ajax: function(t, e) {
                        ...
                        t = void 0),
                        e = e || {};
                        var r, i, a, o, s, l, c, u, h, f, p = O.ajaxSetup({}, e), d = p.context || p, g = p.context && (d.nodeType || d.jquery) ? O(d) : O.event, m = O.Deferred(), b = O.Callbacks("once memory"), v = p.statusCode || {}, y = {}, A = {}, w = "canceled", C = {
                            readyState: 0,
                            ...
                            setRequestHeader: function(t, e) {
                                return null == c && (t = A[t.toLowerCase()] = A[t.toLowerCase()] || t,
                                y[t] = e),
                                this
                            },
                        ...
                        if (m.promise(C),
                        p.url = ((t || p.url || Ne.href) + "").replace(Ye, Ne.protocol + "//"),
                        ...
                        null == p.crossDomain) {
                            ...
                            try {
                                l.href = p.url,
                                l.href = l.href,
                                p.crossDomain = tn.protocol + "//" + tn.host !== l.protocol + "//" + l.host
                            } catch (k) {
                                p.crossDomain = !0
                            }
                        }
                        if (p.data && p.processData && "string" !== typeof p.data && (p.data = O.param(p.data, p.traditional)),
                        nn(Ke, p, e, C),
                        c)
                            return C;
                        for (h in u = O.event && p.global,
                        u && 0 === O.active++ && O.event.trigger("ajaxStart"),
                        p.type = p.type.toUpperCase(),
                        p.hasContent = !Ue.test(p.type),
                        i = p.url.replace(Xe, ""),
                        p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(qe, "+")) : (f = p.url.slice(i.length),
                        p.data && (p.processData || "string" === typeof p.data) && (i += (Re.test(i) ? "&" : "?") + p.data,
                        delete p.data),
                        !1 === p.cache && (i = i.replace(He, "$1"),
                        f = (Re.test(i) ? "&" : "?") + "_=" + Me.guid++ + f),
                        p.url = i + f),
                        p.ifModified && (O.lastModified[i] && C.setRequestHeader("If-Modified-Since", O.lastModified[i]),
                        O.etag[i] && C.setRequestHeader("If-None-Match", O.etag[i])),
                        ...
                        if (p.beforeSend && (!1 === p.beforeSend.call(d, C, p) || c))
                            return C.abort();
                        if (w = "abort",
                        b.add(p.complete),
                        C.done(p.success),
                        ...
                        function S(t, e, o, l) {
                            ...
                            h = t >= 200 && t < 300 || 304 === t,
                            o && (x = an(p, C, o)),
                            !h && O.inArray("script", p.dataTypes) > -1 && O.inArray("json", p.dataTypes) < 0 && (p.converters["text script"] = function() {}
                            ),
                            x = on(p, x, C, h),
                            h ? (p.ifModified && (A = C.getResponseHeader("Last-Modified"),
                            A && (O.lastModified[i] = A),
                            ...
                            C.status = t,
                            C.statusText = (e || w) + "",
                            h ? m.resolveWith(d, [f, w, C]) : m.rejectWith(d, [C, w, y]),
                            C.statusCode(v),
                            v = void 0,
                            u && g.trigger(h ? "ajaxSuccess" : "ajaxError", [C, p, h ? f : y]),
                            b.fireWith(d, [C, w]),
                ...
                var sn = {
                  ...
                  , ln = O.ajaxSettings.xhr();
                b.cors = !!ln && "withCredentials"in ln,
                b.ajax = ln = !!ln,
                O.ajaxTransport((function(t) {
                    var e, r;
                    if (b.cors || ln && !t.crossDomain)
                        return {
                            send: function(i, a) {
                                var o, s = t.xhr();
                                ...
                                e = function(t) {
                                    return function() {
                                        ...
                                        "abort" === t ? s.abort() : "error" === t ? "number" !== typeof s.status ? a(0, "error") : a(s.status, s.statusText) : a(sn[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" !== typeof s.responseText ? {
                                            binary: s.response
                                        } : {
                                            text: s.responseText
                ...
                O.ajaxTransport("script", (function(t) {
                    ...
                    if (t.crossDomain || t.scriptAttrs)
                        return {
                            send: function(r, i) {
                                e = O("<script>").attr(t.scriptAttrs || {}).prop({
                ...
                O.ajaxSetup({
                    ...
                    jsonpCallback: function() {
                        var t = cn.pop() || O.expando + "_" + Me.guid++;
                        return this[t] = !0,
                        t
                    }
                }),
                O.ajaxPrefilter("json jsonp", (function(t, e, r) {
                    var i, a, o, s = !1 !== t.jsonp && (un.test(t.url) ? "url" : "string" === typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && un.test(t.data) && "data");
                    if (s || "jsonp" === t.dataTypes[0])
                        return i = t.jsonpCallback = v(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
                        s ? t[s] = t[s].replace(un, "$1" + i) : !1 !== t.jsonp && (t.url += (Re.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
                        t.converters["script json"] = function() {
                            return o || O.error(i + " was not called"),
                            o[0]
                        }
                        ,
                        t.dataTypes[0] = "json",
                        ...
                        ,
                        r.always((function() {
                            void 0 === a ? O(n).removeProp(i) : n[i] = a,
                ...
                O.parseHTML = function(t, e, n) {
                    ...
                    e = !1),
                    e || (b.createHTMLDocument ? (e = x.implementation.createHTMLDocument(""),
                    r = e.createElement("base"),
                    r.href = x.location.href,
                    e.head.appendChild(r)) : e = x),
                    i = Q.exec(t),
                    a = !n && [],
                    i ? [e.createElement(i[1])] : (i = Nt([t], e, a),
                ...
                O.fn.load = function(t, e, n) {
                    ...
                    o.length > 0 && O.ajax({
                        ...
                        a = arguments,
                        o.html(r ? O("<div>").append(O.parseHTML(t)).find(r) : t)
                    }
                ...
                O.offset = {
                    setOffset: function(t, e, n) {
                        var r, i, a, o, s, l, c, u = O.css(t, "position"), h = O(t), f = {};
                ...
                O.fn.extend({
                    ...
                    position: function() {
                        if (this[0]) {
                            ...
                            if ("fixed" === O.css(r, "position"))
                                ...
                                while (t && (t === n.body || t === n.documentElement) && "static" === O.css(t, "position"))
                                    t = t.parentNode;
                                t && t !== r && 1 === t.nodeType && (i = O(t).offset(),
                                i.top += O.css(t, "borderTopWidth", !0),
                    ...
                    offsetParent: function() {
                        return this.map((function() {
                            ...
                            while (t && "static" === O.css(t, "position"))
                                t = t.offsetParent;
                            return t || yt
                        }
                        ))
                ...
                O.each(["top", "left"], (function(t, e) {
                    O.cssHooks[e] = ne(b.pixelPosition, (function(t, n) {
                        if (n)
                            return n = ee(t, e),
                            Yt.test(n) ? O(t).position()[e] + "px" : n
                    }
                    ))
                }
                )),
                    ...
                    O.each({
                        ...
                        O.fn[r] = function(i, a) {
                            ...
                            return rt(this, (function(e, n, i) {
                                ...
                                Math.max(e.body["scroll" + t], a["scroll" + t], e.body["offset" + t], a["offset" + t], a["client" + t])) : void 0 === i ? O.css(e, n, s) : O.style(e, n, i, s)
                            }
                            ), e, o ? i : void 0, o)
                        }
                    }
                ...
                return O.noConflict = function(t) {
                    return n.$ === O && (n.$ = pn),
                    t && n.jQuery === O && (n.jQuery = fn),
                    O
                }
                ,
                "undefined" === typeof a && (n.jQuery = n.$ = O),
                O
            }
            ))
        },
        ...
        "13d2": function(t, e, n) {
            var r = n("e330")
              ...
              , x = t.exports = function(t, e, n) {
                ...
                n && n.getter && (e = "get " + e),
                n && n.setter && (e = "set " + e),
                (!o(t, "name") || l && t.name !== e) && (s ? d(t, "name", {
                    value: e,
                    configurable: !0
                }) : t.name = e),
                v && n && o(n, "arity") && t.length !== n.arity && d(t, "length", {
                    value: n.arity
                });
                try {
                ...
                var r = h(t);
                return o(r, "source") || (r.source = b(y, "string" == typeof e ? e : "")),
                t
            }
            ;
        ...
        "23e7": function(t, e, n) {
            var r = n("da84")
              ...
              , c = n("94ca");
            t.exports = function(t, e) {
                var n, u, h, f, p, d, g = t.target, m = t.global, b = t.stat;
                if (u = m ? r : b ? r[g] || s(g, {}) : (r[g] || {}).prototype,
                u)
                    for (h in e) {
                        if (p = e[h],
                        t.dontCallGetSet ? (d = i(u, h),
                        f = d && d.value) : f = u[h],
                        n = c(m ? h : g + (b ? "." : "#") + h, t.forced),
                        !n && void 0 !== f) {
        ...
        "2d00": function(t, e, n) {
            var r, i, a = n("da84"), o = n("342f"), s = a.process, l = a.Deno, c = s && s.versions || l && l.version, u = c && c.v8;
            u && (r = u.split("."),
            ...
            function a(t) {
                return r((function(e, n) {
                    var r = -1
                      ...
                      , o = a > 1 ? n[a - 1] : void 0
                      , s = a > 2 ? n[2] : void 0;
                    o = t.length > 3 && "function" == typeof o ? (a--,
                    o) : void 0,
        ...
        "34ac": function(t, e, n) {
            var r = n("9520")
              ...
              , h = c.toString
              , f = u.hasOwnProperty
              , p = RegExp("^" + h.call(f).replace(s, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
            function d(t) {
                if (!a(t) || i(t))
                    return !1;
                var e = r(t) ? p : l;
        ...
        3818: function(t, e, n) {
            var r = n("7e64")
              ...
              , $ = "[object Uint32Array]"
              , tt = {};
            function et(t, e, n, E, D, L) {
                var G, M = e & k, R = e & O, V = e & T;
                if (n && (G = D ? n(t, E, D, L) : n(t)),
                void 0 !== G)
                    return G;
                if (!A(t))
                    return t;
                ...
                if (W)
                    return W;
                L.set(t, G),
                w(t) ? t.forEach((function(r) {
                    G.add(et(r, e, n, r, t, L))
                }
                )) : x(t) && t.forEach((function(r, i) {
                    G.set(i, et(r, e, n, i, t, L))
                }
                ));
                var F = V ? R ? p : f : R ? S : C
                  , q = P ? void 0 : F(t);
                return i(q || t, (function(r, i) {
                    q && (i = r,
                    r = t[i]),
                    a(G, i, et(r, e, n, i, t, L))
                }
                )),
                G
            }
            tt[I] = tt[E] = tt[F] = tt[q] = tt[D] = tt[L] = tt[X] = tt[H] = tt[Z] = tt[J] = tt[U] = tt[M] = tt[R] = tt[B] = tt[V] = tt[P] = tt[z] = tt[Q] = tt[Y] = tt[K] = tt[_] = tt[$] = !0,
            tt[G] = tt[j] = tt[W] = !1,
            t.exports = et
        },
        "39ff": function(t, e, n) {
        ...
        "42a2": function(t, e, n) {
            var r = n("b5a7")
              ...
              , x = c(s)
              , A = l;
            (r && A(new r(new ArrayBuffer(1))) != g || i && A(new i) != u || a && A(a.resolve()) != f || o && A(new o) != p || s && A(new s) != d) && (A = function(t) {
                var e = l(t)
                ...
                if (S)
                    ...
                    if (O) {
                        var T = c(C)
                          ...
                          , E = !T && !I && g(C);
                        k = C,
                        T || I || E ? c(w) ? k = w : u(w) ? k = o(w) : I ? (O = !1,
                        k = i(C, !0)) : E ? (O = !1,
                        k = a(C, !0)) : k = [] : d(C) || l(C) ? (k = w,
                        l(w) ? k = b(w) : p(w) && !f(w) || (k = s(C))) : O = !1
                    }
                    O && (A.set(C, k),
                    y(k, C, v, x, A),
                    A["delete"](C)),
        ...
        "69f3": function(t, e, n) {
            var r, i, a, o = n("cdce"), s = n("da84"), l = n("861d"), c = n("9112"), u = n("1a2d"), h = n("c6cd"), f = n("f772"), p = n("d012"), d = "Object already initialized", g = s.TypeError, m = s.WeakMap, b = function(t) {
                return a(t) ? i(t) : r(t, {})
            }, v = function(t) {
                return function(e) {
                    var n;
        ...
        "6fcd": function(t, e, n) {
            ...
            function h(t, e) {
                var n = a(t)
                  ...
                  , g = d.length;
                for (var m in t)
                    !e && !u.call(t, m) || p && ("length" == m || h && ("offset" == m || "parent" == m) || f && ("buffer" == m || "byteLength" == m || "byteOffset" == m) || s(m, g)) || d.push(m);
                return d
            }
            t.exports = h
        },
        ...
        "743f": function(t, e, n) {
            var r = n("3729")
              ...
              , D = {};
            function L(t) {
                return a(t) && i(t.length) && !!D[r(t)]
            }
            D[A] = D[w] = D[C] = D[S] = D[k] = D[O] = D[T] = D[I] = D[E] = !0,
            D[o] = D[s] = D[y] = D[l] = D[x] = D[c] = D[u] = D[h] = D[f] = D[p] = D[d] = D[g] = D[m] = D[b] = D[v] = !1,
            t.exports = L
        },
        7530: function(t, e, n) {
            var r = n("1a8c")
        ...
        "7b97": function(t, e, n) {
            ...
            function b(t, e, n, g, b, v) {
                ...
                if (k && !C)
                    return v || (v = new r),
                    y || u(t) ? i(t, e, n, g, b, v) : a(t, e, A, n, g, b, v);
                if (!(n & h)) {
                    var O = C && m.call(t, "__wrapped__")
            ...
            function l(t, e, n, l, c, u) {
                ...
                while (++m < f) {
                    var y = t[m]
                      , x = e[m];
                    if (l)
                        var A = h ? l(x, y, m, e, t, u) : l(y, x, m, t, e, u);
                    if (void 0 !== A) {
                        if (A)
                            continue;
                        b = !1;
            ...
            function s(t, e, n, a, s, l) {
                ...
                while (++d < h) {
                    ...
                    var x = t[g]
                      , A = e[g];
                    if (a)
                        var w = c ? a(A, x, g, e, t, l) : a(x, A, g, t, e, l);
                    if (!(void 0 === w ? x === A || s(x, A, n, a, l) : w)) {
                        v = !1;
                        break
                    }
                    y || (y = "constructor" == g)
                ...
                if (v && !y) {
                    var C = t.constructor
                      , S = e.constructor;
                    C == S || !("constructor"in t) || !("constructor"in e) || "function" == typeof C && C instanceof C && "function" == typeof S && S instanceof S || (v = !1)
                }
                return l["delete"](t),
                l["delete"](e),
                v
        ...
        b622: function(t, e, n) {
            ...
            t.exports = function(t) {
                return a(u, t) || (u[t] = s && a(c, t) ? c[t] : h("Symbol." + t)),
                u[t]
            }
        },
        b760: function(t, e, n) {
        ...
        c05f: function(t, e, n) {
            ...
            function a(t, e, n, o, s) {
                return t === e || (null == t || null == e || !i(t) && !i(e) ? t !== t && e !== e : r(t, e, n, o, a, s))
            }
            t.exports = a
        },
        c098: function(t, e) {
            ...
            function i(t, e) {
                var i = typeof t;
                return e = null == e ? n : e,
                !!e && ("number" == i || "symbol" != i && r.test(t)) && t > -1 && t % 1 == 0 && t < e
            }
            t.exports = i
        },
        c1c9: function(t, e, n) {
        ...
        f909: function(t, e, n) {
            var r = n("7e64")
              ...
              , l = n("9934")
              , c = n("8adb");
            function u(t, e, n, h, f) {
                t !== e && a(e, (function(a, l) {
                    if (f || (f = new r),
                    s(a))
                        o(t, e, l, n, u, h, f);
                    else {
                        var p = h ? h(c(t, l), a, l + "", t, e, f) : void 0;
                        void 0 === p && (p = a),
                        i(t, l, p)
                    }
                }
        ...
        fb15: function(t, e, n) {
            ...
            var r = {};
            if (n.r(r),
            n.d(r, "ChartBaseLabel", (function() {
                return Fe
            }
            )),
            n.d(r, "ChartBaseSwitch", (function() {
                return Ue
            }
            )),
            n.d(r, "ChartBaseInput", (function() {
                return en
            }
            )),
            n.d(r, "ChartBaseSelect", (function() {
                return ln
            }
            )),
            n.d(r, "ChartBaseSlider", (function() {
                return dn
            }
            )),
            n.d(r, "ChartBaseBox", (function() {
                return xn
            }
            )),
            ...
            var o = function() {
                ...
                return e("div", {
                    ...
                    attrs: {
                        chartAllType: t.currentChartType,
                        showList: t.showList,
                        lang: t.lang
                    },
                    on: {
                        closeChartShowList: function(e) {
                            t.showList = !1
                        }
                    }
                }), e("div", [e("el-tabs", {
                ...
                }), t._v(" " + t._s(t.setItem.data) + " ")]), e("el-row", [e("el-col", {
                    attrs: {
                        span: 2
                    }
                }, [e("div", [t._v(" ")])]), e("el-col", {
                ...
                }, [t._v(t._s(t.setItem.chartType))]), e("div", {
                    staticStyle: {
                        "margin-top": "10px"
                    }
                }, [e("el-button", {
                    ...
                    class: t.chartTypeTxt[0],
                    staticStyle: {
                        float: "left"
                    }
                }), t._v(" " + t._s(t.chartTypeTxt[1]) + " "), e("i", {
                ...
                }), t.chartXYSeriesList ? e("div", t._l(t.chartXYSeriesList.fix, (function(n) {
                    return e("div", {
                        key: n.title,
                        staticStyle: {
                            "margin-top": "10px"
                    ...
                    }), t._v(" " + t._s(n.field) + " ")])], 1)], 1)], 1)
                }
                )), 0) : t._e(), e("div", {
                    staticStyle: {
                        "margin-top": "25px"
                    }
                }), t.chartXYSeriesList ? e("div", t._l(t.chartXYSeriesList.change, (function(n, r) {
                    return e("div", {
                        key: r,
                        staticStyle: {
                            "margin-top": "10px"
                        ...
                        slot: "dropdown"
                    }, t._l(t.chartXYSeriesList.option, (function(r, i) {
                        ...
                        }, [t._v(" " + t._s(r.field) + " "), n.id == r.id ? e("i", {
                    ...
                    on: {
                        change: t.checkBoxChange
                    },
                    model: {
                        value: t.currentRangeConfigCheck,
                        callback: function(e) {
                            t.currentRangeConfigCheck = e
                        },
                        expression: "currentRangeConfigCheck"
                    }
                }, [t._v(t._s(t.setItem.transpose))]), e("div", {
                    staticStyle: {
                        margin: "15px 0"
                    }
                }), e("el-checkbox", {
                    attrs: {
                        disabled: t.checkRowDisabled
                    },
                    on: {
                        change: t.checkBoxChange
                    },
                    model: {
                        value: t.currentRangeRowCheck.exits,
                        callback: function(e) {
                            t.$set(t.currentRangeRowCheck, "exits", e)
                        },
                        expression: "currentRangeRowCheck.exits"
                    }
                }, [t._v(t._s(t.setItem.row1) + " " + t._s(t.getColRowCheckTxt(!0)) + " " + t._s(t.setItem.row2))]), e("div", {
                    staticStyle: {
                        margin: "15px 0"
                    }
                }), e("el-checkbox", {
                    attrs: {
                        disabled: t.checkColDisabled
                    },
                    on: {
                        change: t.checkBoxChange
                    },
                    model: {
                        value: t.currentRangeColCheck.exits,
                        callback: function(e) {
                            t.$set(t.currentRangeColCheck, "exits", e)
                        },
                        expression: "currentRangeColCheck.exits"
                    }
                }, [t._v(t._s(t.setItem.column1) + " " + t._s(t.getColRowCheckTxt()) + " " + t._s(t.setItem.column2))])], 1)], 1)], 1)], 1), e("el-tab-pane", [e("span", {
                    attrs: {
                        slot: "label"
                    },
                    slot: "label"
                ...
                }), t._v(" " + t._s(t.setItem.style) + " ")]), e("el-row", [e("el-col", {
                    attrs: {
                        span: 1
                    }
                }, [e("div", [t._v(" ")])]), e("el-col", {
                ...
                }, [e("el-collapse", [e("chart-title", {
                    attrs: {
                        router: "title",
                        chartAllType: t.currentChartType,
                        titleOption: t.titleOption,
                        lang: t.lang
                    }
                }), e("chart-sub-title", {
                    attrs: {
                        router: "subtitle",
                        chartAllType: t.currentChartType,
                        subTitleOption: t.subTitleOption,
                        lang: t.lang
                    }
                }), e("chart-cursor", {
                    attrs: {
                    ...
                    attrs: {
                        router: "legend",
                        chartAllType: t.currentChartType,
                        legendOption: t.legendOption,
                        lang: t.lang
                    }
                }), "pie" != t.currentChartType.split("|")[1] ? e("chart-axis", {
                    attrs: {
                        router: "axis",
                        axisOption: t.axisOption,
                        chartAllType: t.currentChartType,
                        lang: t.lang
                    }
                }) : t._e()], 1)], 1), e("el-col", {
            ...
            function() {
                ...
                return t.showList ? e("div", {
                    ...
                    on: {
                        click: function(e) {
                            return t.$emit("closeChartShowList")
                        }
                    }
                }, [e("i", {
                ...
                }), t._v(" " + t._s(t.close) + " ")]), e("el-radio-group", {
                    staticStyle: {
                        display: "block",
                        "text-align": "center"
                    },
                ...
                }, t._l(t.currentConfig.data, (function(n, r) {
                    return e("div", {
                        key: r,
                        attrs: {
                            "data-type": n.type,
                            id: "luckysheet-datavisual-chart-menu-" + n.type
                        },
                        on: {
                            click: t.quickMenu
                        }
                    ...
                    return [e("div", {
                        ...
                        attrs: {
                            "data-type": n.type,
                            id: "luckysheet-datavisual-chart-listtitle-" + n.type
                        }
                    }, [e("i", {
                        staticClass: "iconfont",
                        class: n.icon,
                        ...
                        return e("el-tooltip", {
                            ...
                            class: n.type == t.currentChartType ? "luckysheet-datavisual-quick-list-item-active" : "",
                            attrs: {
                                chartAllType: n.type,
                                "data-style": n.type.split("-")[2],
                                "data-type": n.type.split("-")[1]
                            },
                            on: {
                                click: function(e) {
                                    return t.changeChartType(n.type)
                                }
                            }
                        }, [e("img", {
                            attrs: {
                                src: 0 == n.img.length ? "data:image/svg+xml;base64," : n.img,
                                alt: "图片"
                            }
                        })])])
                    }
            ...
            const d = {
              ...
              , w = [{
                ...
                value: 1e-4,
                label: "Divide by 10000"
            }, {
                value: 1e-5,
                label: "除以10万"
            }, {
                value: 1e-6,
                label: "Divide by 1,000,000"
            }, {
                value: 1e-7,
                label: "Divide by 10,000,000"
            }, {
                value: 1e-8,
                label: "Divide by 100,000,000"
            }, {
                value: 1e-9,
                label: "Divide by 1,000,000,000"
            }]
              , C = [{
                value: "auto",
                label: "Auto display"
              ...
              , E = [["地区", "衣服", "食材", "图书"], ["上海", 134, 345, 51], ["北京", 345, 421, 234], ["广州", 453, 224, 156], ["杭州", 321, 634, 213], ["南京", 654, 542, 231]]
              , D = {
            ...
            function L(t) {
                ...
                if (j(t)) {
                    ...
                    e = t;
                else if (e = Array.isArray(t) ? [] : {},
                t instanceof HTMLElement)
                    e = t.cloneNode(!0);
                else
                    for (let n in t)
                        Object.prototype.hasOwnProperty.call(t, n) && (e[n] = j(t[n]) || G(t[n]) ? L(t[n]) : t[n]);
                return e
            }
            function G(t) {
                return !j(t) && ("object" === typeof t || "function" === typeof t) && null !== t
            }
            function j(t) {
            ...
            function N(t) {
                null == t && (t = "chart");
                for (var e = window.navigator.userAgent.replace(/[^a-zA-Z0-9]/g, "").split(""), n = "", r = 0; r < 12; r++)
                    n += e[Math.round(Math.random() * (e.length - 1))];
                var i = (new Date).getTime();
                return t + "_" + n + "_" + i
            }
            function M(t) {
                return !(null == t || t.toString().length < 5) && !!e(t);
                function e(t) {
                    var e = /^(\d{4})-(\d{1,2})-(\d{1,2})(\s(\d{1,2}):(\d{1,2})(:(\d{1,2}))?)?$/
                    ...
                    if (a > 31)
                        return !1;
                    if (2 == i) {
                        if (29 == new Date(r,1,29).getDate() && a > 29)
                            return !1;
                        if (29 != new Date(r,1,29).getDate() && a > 28)
                            return !1
                    }
                    return !0
                }
            ...
            function B(t) {
                var e = /[Enter Title]|[\uFE30-\uFFA0]/gi;
                return !!e.exec(t)
            }
            function V(t) {
                var e = "string";
                return M(t) ? e = "date" : isNaN(parseFloat(t)) || B(t) || (e = "num"),
                e
            }
            function P(t) {
            ...
            function F(t) {
                var e, n, r = t.length - 1, i = t[0].length - 1;
                while (r >= 0 && i >= 0) {
                    var a = t[r][i];
                    if (!(null === a || R(a) || "object" == W(a) && R(a.v) || "object" == W(a) && "undefined" == W(a.v) || "" === a || "" === a.v)) {
                        r == t.length - 1 && i == t[0].length - 1 ? (e = r,
                        n = i) : (e = r + 1,
                        n = i + 1);
                        break
                    }
                    if (a && a.ct && "yyyy-MM-dd" == a.ct.fa) {
                        e = r + 1,
                        n = i + 1;
                        break
                    }
                ...
                return o.range[1] + 1 == t.length && (o = {
                    exits: !1,
                    range: [0, 0]
                }),
                l.range[1] + 1 == t[0].length && (l = {
                    exits: !1,
                    range: [0, 0]
                }),
                [o, l]
            ...
            function q(t, e, n, r) {
                ...
                i = n.exits && r.exits ? {
                    ...
                    rowtitle: {
                        row: r.range,
                        column: [n.range[1] + 1, t[0].length - 1]
                    },
                    coltitle: {
                        row: [r.range[1] + 1, t.length - 1],
                        column: n.range
                    },
                    content: {
                        row: [r.range[1] + 1, t.length - 1],
            ...
            function X(t, e, n) {
                var r = null
                  , i = n[t][e];
                return null != i && (r = null != i.v ? i.v : i),
                void 0 == r && (r = ""),
                r
            }
            function H(t, e, n, r, i, a) {
                var o = {};
                if ("line" == r || "column" == r || "area" == r || "scatter" == r || "bar" == r || "pie" == r || "radar" == r || "funnel" == r || "gauge" == r || "map" == r)
                    if (a) {
                        if ("normal" == e.type) {
                            var s = e
                              , l = s.rowtitle
                            ...
                            if (null != l) {
                                o.title = {
                                    text: X(s.title.row[0], s.title.column[0], t)
                                };
                                for (var u = l.column[0]; u <= l.column[1]; u++) {
                                    for (var h = "", f = l.row[0]; f <= l.row[1]; f++)
                                        h += "\n" + X(f, u, t);
                                    h = h.substr(1, h.length),
                                    "highcharts" == n && (h = h.replace(/\n/g, "<br/>")),
                                    c.push(h)
                                }
                                o.xAxis = c
                            }
                            var p = s.coltitle
                              , d = [];
                            if (null != p) {
                                for (f = p.row[0]; f <= p.row[1]; f++) {
                                    for (h = "",
                                    u = p.column[0]; u <= p.column[1]; u++)
                                        h += " " + X(f, u, t);
                                    d.push(h.substr(1, h.length))
                                }
                                o.label = d
                            }
                            var g = s.content
                            ...
                            if (null != g) {
                                var b = {};
                                for (u = g.column[0]; u <= g.column[1]; u++) {
                                    var v = []
                                      , y = 0;
                                    for (f = g.row[0]; f <= g.row[1]; f++) {
                                        h = X(f, u, t);
                                        v.push(h),
                                        u == g.column[0] && (b[y++] = V(h))
                                    }
                                    m.push(v)
                                }
                                o.series = m,
                            ...
                            if (null != g) {
                                for (b = {},
                                u = g.column[0]; u <= g.column[1]; u++) {
                                    for (v = [],
                                    y = 0,
                                    f = g.row[0]; f <= g.row[1]; f++) {
                                        h = X(f, u, t);
                                        v.push(h),
                                        u == g.column[0] && (b[y++] = V(h))
                                    }
                            ...
                            if (null == l) {
                                ...
                                for (u = 0; u <= g.column[1] - g.column[0]; u++)
                                    c.push(u + 1);
                                o.xAxis = c
                            }
                        } else if ("topbottom" == e.type) {
                            s = e,
                            l = s.rowtitle,
                            c = [];
                            if (null != l) {
                                ...
                                for (u = l.column[0]; u <= l.column[1]; u++) {
                                    for (h = "",
                                    f = l.row[0]; f <= l.row[1]; f++)
                                        h += "\n" + X(f, u, t);
                                    h = h.substr(1, h.length),
                                    "highcharts" == n && (h = h.replace(/\n/g, "<br/>")),
                                    c.push(h)
                            ...
                            d = [];
                            if (null == p) {
                                for (f = 0; f <= g.row[1] - g.row[0]; f++)
                                    d.push("Series" + (f + 1));
                                o.label = d
                            }
                        } else if ("contentonly" == e.type) {
                            s = e,
                            g = s.content,
                            m = [];
                            if (null != g) {
            ...
            function J(t, e, n, r, i, a, o) {
                if (e.xAxis && "bar" != i) {
                    if (null == t.axis.xAxisDown.data || 0 == t.axis.xAxisDown.data.length || t.axis.xAxisDown.data.length != e.xAxis.length)
                        t.axis.xAxisDown.data = e.xAxis;
                    else
                        for (var s = 0; s < t.axis.xAxisDown.data.length; s++) {
                            var l = t.axis.xAxisDown.data[s];
                            l instanceof Object ? l.value = e.xAxis[s] : t.axis.xAxisDown.data[s] = e.xAxis[s]
                        }
                    t.axis.xAxisDown.type = "category",
                    t.axis.yAxisLeft.type = "value"
                }
                if ("echarts" == r && "bar" == i) {
                    if (null == t.axis.yAxisLeft.data || 0 == t.axis.yAxisLeft.data.length || t.axis.yAxisLeft.data.length != e.xAxis.length)
                        t.axis.yAxisLeft.data = e.xAxis;
                    else
                        for (s = 0; s < t.axis.yAxisLeft.data.length; s++) {
                            l = t.axis.yAxisLeft.data[s];
                            l instanceof Object ? l.value = e.xAxis[s] : t.axis.yAxisLeft.data[s] = e.xAxis[s]
                        }
                    t.axis.yAxisLeft.type = "category",
                    t.axis.xAxisDown.type = "value"
                }
                if (e.series) {
                    var c = P(Q(e.series, n))
                      , u = z(e.label, n);
                    t.legend.data = u,
                    t.seriesData = c,
                    "pie" == i ? ot(t, e, c, u, r, i, a) : "line" != i && "area" != i && "bar" != i && "column" != i || U(t, c, u, r, i, a)
                }
                return t
            }
            function U(t, e, n, r, i, a) {
                t.series.length != e.length && (t.series = []);
                for (var o = 0; o < e.length; o++)
                    null == t.series[o] ? t.series[o] = Y(t.series[o], e[o], n[o], r, i, a) : t.series[o] = et(t.series[o], e[o], n[o], r, i, a)
            }
            function Y(t, e, n, r, i, a) {
                t = {
                    itemStyle: L(d.item),
                    lineStyle: L(d.lineStyle),
                    data: e,
                    type: i,
                    name: n,
                    markPoint: {
                ...
                let o = new Map([["line", K], ["area", _], ["bar", tt], ["column", $]]);
                return o.get(i)(t, e, n, r, i, a)
            }
            function K(t, e, n, r, i, a) {
                return "smooth" == a && (t.smooth = !0),
                "label" == a && (t.label = {
                    show: !0,
                    formatter: "{c}",
                    fontSize: 10,
            ...
            function tt(t, e, n, r, i, a) {
                return "stack" == a && (t.stack = "示例"),
                t
            }
            function et(t, e, n, r, i, a) {
                if (null == t.data || 0 == t.data.length || t.data.length != e.length)
                    t.data = e,
                    t.name = n,
                    t.type = i;
                else {
                    for (var o = 0; o < t.data.length; o++) {
                        var s = t.data[o];
                        s instanceof Object ? s.value = e[o] : t.data[o] = e[o]
                    }
                    t.name = n,
                    t.type = i
                }
                let l = new Map([["line", nt], ["area", rt], ["bar", it], ["column", at]]);
                return l.get(i)(t, e, n, r, i, a)
            }
            function nt(t, e, n, r, i, a) {
                return t
            }
            function rt(t, e, n, r, i, a) {
                return t.type = "line",
                t
            }
            ...
            function ot(t, e, n, r, i, a, o) {
                t.legend.data = [];
                for (var s = 0; s < e.xAxis.length; s++)
                    t.legend.data.push({
                        name: e.xAxis[s],
                        textStyle: {
                            color: null
                ...
                for (s = 0; s < n.length; s++) {
                    if (s > 0)
                        return;
                    null == t.series[s] ? t.series[s] = st(t.series[s], e, n[s], r[s], i, a, o) : t.series[s] = lt(t.series[s], e, n[s], r[s], i, a, o)
                }
            }
            function st(t, e, n, r, i, a, o) {
                ...
                "split" == o)
                    for (var l = 0; l < t.data.length; l++)
                        t.data[l].selected = "true",
                        t.data[l].selectedOffset = 5;
                return "ring" == o && (t.radius = ["50%", "85%"],
                t.avoidLabelOverlap = !1,
                t.label = {
                    normal: {
                        show: !0,
                        position: "outside"
            ...
            function lt(t, e, n, r, i, a, o) {
                ...
                for (let s = 0; s < n.length; s++) {
                    ...
                    t.data[s].value = r,
                    t.data[s].y = r,
                    t.data.length < n.length)
                        for (let e = t.data.length; e < n.length; e++)
                            t.data.push({
                                value: r,
                                name: i,
                                y: r
                    ...
                    if (t.data.length > n.length)
                        for (let e = n.length; e < t.data.length; e++)
                            t.data[e].value = "",
                            t.data[e].y = "",
                            t.data[e].name = ""
                }
            ...
            const ct = function(t, e, n) {
                ...
                r.text = e.text,
                r.subtext = n.text,
                ge(e, r, "textStyle", "text"),
                ge(n, r, "subtextStyle", "subtext"),
                "custom" === e.position.value ? (r.left = e.position.offsetX + "%",
                r.top = e.position.offsetY + "%") : (r.left = e.position.value.split("-")[0],
                r.top = e.position.value.split("-")[1]);
                let i = new Map([["auto", 10], ["far", 30], ["close", 5], ["normal", 20], ["custom", n.distance.cusGap]]);
                return r.itemGap = i.get(n.distance.value),
                r
            };
            var ut = ct;
            const ht = function(t, e) {
                ...
                n.show = e.show,
                ge(e, n, "textStyle"),
                "custom" === e.position.value ? (n.left = e.position.offsetX,
                n.top = e.position.offsetY) : (n.left = e.position.value.split("-")[0],
                n.top = e.position.value.split("-")[1]),
                n.orient = e.position.direction;
                let r = new Map([["auto", 25], ["big", 45], ["medium", 18], ["small", 10], ["custom", e.width.cusSize]])
                  , i = new Map([["auto", 14], ["big", 30], ["medium", 20], ["small", 10], ["custom", e.height.cusSize]]);
                n.itemWidth = r.get(e.width.value),
                n.itemHeight = i.get(e.height.value);
                let a = new Map([["auto", 10], ["far", 20], ["near", 5], ["general", 15], ["custom", e.distance.cusGap]]);
                return n.itemGap = a.get(e.distance.value),
                n
            };
            var ft = ht;
            const pt = function(t, e) {
                ...
                n.triggerOn = e.triggerOn,
                ge(e, n, "textStyle"),
                n.backgroundColor = e.backgroundColor,
                n.axisPointer.lineStyle = e.axisPointer.style,
                n.axisPointer.type = e.axisPointer.type,
                n.position = "auto" == e.position ? null : e.position;
                e.format;
                return n
            };
            var dt = pt;
            const gt = function(t, e) {
                let n = t[1]
                  ...
                  , i = function(t, r) {
                    let i = L(e[r]);
                    return t = h.a.extend(t, i),
                    t.show = i.show,
                    t.name = i.title.text,
                    ge(i.title, t, "nameTextStyle"),
                    t.nameLocation = i.title.fzPosition,
                    t.inverse = i.inverse,
                    "value" != t.type && (t.interval = i.tickLabel.optimize),
                    t.nameGap = i.title.rotate,
                    t.axisLine.show = i.tickLine.show,
                    t.axisLine.lineStyle = be(i.tickLine.width, i.tickLine.color),
                    t.axisTick.show = i.tick.show,
                    t.axisTick.lineStyle = be(i.tick.width, i.tick.color),
                    t.axisTick.inside = "inside" == i.tick.position,
                    t.axisTick.length = i.tick.length,
                    t.axisLabel.show = i.tickLabel.show,
                    t.axisLabel.rotate = i.tickLabel.rotate,
                    "bar" == n && "x" == r.slice(0, 1) || "bar" != n && "y" == r.slice(0, 1) ? (t.min = i.tickLabel.min,
                    t.max = i.tickLabel.max,
                    t.axisLabel.formatter = function(t) {
                        return "auto" == i.tickLabel.digit ? i.tickLabel.prefix + me.multiply(+t, i.tickLabel.ratio) + i.tickLabel.suffix : i.tickLabel.prefix + me.multiply(+t, i.tickLabel.ratio).toFixed(i.tickLabel.digit) + i.tickLabel.suffix
                    }
                    ) : t.axisLabel.formatter = function(t) {
                        return i.tickLabel.prefix + t + i.tickLabel.suffix
                    }
                    ,
                    t.splitLine.show = i.netLine.show,
                    t.splitLine.lineStyle = be(i.netLine.width, i.netLine.color, i.netLine.type),
                    t.splitLine.interval = ve(i.netLine.interval.value, i.netLine.interval.cusNumber),
                    t.splitArea.show = i.netArea.show,
                    t.splitArea.interval = ve(i.netArea.interval.value, i.netArea.interval.cusNumber),
                    t.splitArea.areaStyle.color = ["auto" == i.netArea.colorOne ? "rgba(250,250,250,0.3)" : i.netArea.colorOne, "auto" == i.netArea.colorTwo ? "rgba(200,200,200,0.3)" : i.netArea.colorTwo],
                    t
                };
                return {
                    xAxisUp: i(L(r), "xAxisUp"),
                    xAxisDown: i(L(r), "xAxisDown"),
                    yAxisLeft: i(L(r), "yAxisLeft"),
                    yAxisRight: i(L(r), "yAxisRight")
                }
            };
            var mt = gt;
            const bt = function(t) {
                const e = t.chartAllType.split("|")
                  , n = (e[0],
                e[1])
                  , r = (e[2],
                ut(e, t.defaultOption.title, t.defaultOption.subtitle))
                  , i = ft(e, t.defaultOption.legend)
                  , a = dt(e, t.defaultOption.tooltip)
                  , o = mt(e, t.defaultOption.axis);
                o.xAxisDown.data = t.defaultOption.axis.xAxisDown.data;
                const s = {
                    title: {
                        ...r
                    },
                    ...
                    yAxis: [o.yAxisLeft, o.yAxisRight],
                    series: t.defaultOption.series ? t.defaultOption.series : [{
                        name: "销量",
                        type: "bar",
                        data: [5, 20, 36, 10, 10, 20]
                    }]
                };
                return "pie" == n && (delete s.xAxis,
                delete s.yAxis),
                s
            };
            var vt = bt
              , yt = n("8bbf")
              , xt = n.n(yt);
            const At = "ENABLE_ACTIVE"
              , wt = "DISABLE_ACTIVE"
              , Ct = "ENABLE_DRAGGABLE"
              , St = "DISABLE_DRAGGABLE"
              , kt = "ENABLE_RESIZABLE"
              , Ot = "DISABLE_RESIZABLE"
              , Tt = "ENABLE_PARENT_LIMITATION"
              , It = "DISABLE_PARENT_LIMITATION"
              , Et = "ENABLE_SNAP_TO_GRID"
              , Dt = "DISABLE_SNAP_TO_GRID"
              , Lt = "ENABLE_ASPECT"
              , Gt = "DISABLE_ASPECT"
              , jt = "ENABLE_X_AXIS"
              , Nt = "ENABLE_Y_AXIS"
            ...
            var qt = {
                ...
                DISABLE_ACTIVE: wt,
                ENABLE_DRAGGABLE: Ct,
                DISABLE_DRAGGABLE: St,
                ENABLE_RESIZABLE: kt,
                DISABLE_RESIZABLE: Ot,
                ENABLE_PARENT_LIMITATION: Tt,
                DISABLE_PARENT_LIMITATION: It,
                ENABLE_SNAP_TO_GRID: Et,
                DISABLE_SNAP_TO_GRID: Dt,
                ENABLE_ASPECT: Lt,
                DISABLE_ASPECT: Gt,
                ENABLE_X_AXIS: jt,
                ENABLE_Y_AXIS: Nt,
              ...
              , Xt = {
                setActive({commit: t, state: e}, {id: n}) {
                    for (let r = 0, i = e.rects.length; r < i; r++)
                        t(r !== n ? qt.DISABLE_ACTIVE : qt.ENABLE_ACTIVE, r)
                },
                unsetActive({commit: t}, {id: e}) {
                    t(qt.DISABLE_ACTIVE, e)
                },
                toggleDraggable({commit: t, state: e}, {id: n}) {
                    e.rects[n].draggable ? t(qt.DISABLE_DRAGGABLE, n) : t(qt.ENABLE_DRAGGABLE, n)
                },
                toggleResizable({commit: t, state: e}, {id: n}) {
                    e.rects[n].resizable ? t(qt.DISABLE_RESIZABLE, n) : t(qt.ENABLE_RESIZABLE, n)
                },
                toggleParentLimitation({commit: t, state: e}, {id: n}) {
                    e.rects[n].parentLim ? t(qt.DISABLE_PARENT_LIMITATION, n) : t(qt.ENABLE_PARENT_LIMITATION, n)
                },
                toggleSnapToGrid({commit: t, state: e}, {id: n}) {
                    e.rects[n].snapToGrid ? t(qt.DISABLE_SNAP_TO_GRID, n) : t(qt.ENABLE_SNAP_TO_GRID, n)
                },
                setAspect({commit: t}, {id: e}) {
                    t(qt.ENABLE_ASPECT, e)
                },
                unsetAspect({commit: t}, {id: e}) {
                    t(qt.DISABLE_ASPECT, e)
                },
                setWidth({commit: t}, {id: e, width: n}) {
                    t(qt.CHANGE_WIDTH, {
                        id: e,
                        width: n
                    })
                },
                setHeight({commit: t}, {id: e, height: n}) {
                    t(qt.CHANGE_HEIGHT, {
                        id: e,
                        height: n
                    })
                },
                setTop({commit: t}, {id: e, top: n}) {
                    t(qt.CHANGE_TOP, {
                        id: e,
                        top: n
                    })
                },
                setLeft({commit: t}, {id: e, left: n}) {
                    t(qt.CHANGE_LEFT, {
                        id: e,
                        left: n
                    })
                },
                changeXLock({commit: t, state: e}, {id: n}) {
                    switch (e.rects[n].axis) {
                    case "both":
                        t(qt.ENABLE_Y_AXIS, n);
                        break;
                    case "x":
                        t(qt.ENABLE_NONE_AXIS, n);
                        break;
                    case "y":
                        t(qt.ENABLE_BOTH_AXIS, n);
                        break;
                    case "none":
                        t(qt.ENABLE_X_AXIS, n);
                        break
                    }
                },
                changeYLock({commit: t, state: e}, {id: n}) {
                    switch (e.rects[n].axis) {
                    case "both":
                        t(qt.ENABLE_X_AXIS, n);
                        break;
                ...
                changeZToBottom({commit: t, state: e}, {id: n}) {
                    if (1 !== e.rects[n].zIndex) {
                        t(qt.CHANGE_ZINDEX, {
                            id: n,
                            zIndex: 1
                        });
                        for (let r = 0, i = e.rects.length; r < i; r++)
                            if (r !== n) {
                                if (e.rects[r].zIndex === e.rects.length)
                                    continue;
                                t(qt.CHANGE_ZINDEX, {
                                    id: r,
                                    zIndex: e.rects[r].zIndex + 1
                                })
                            }
                    }
                },
                changeZToTop({commit: t, state: e}, {id: n}) {
                    if (e.rects[n].zIndex !== e.rects.length) {
                        t(qt.CHANGE_ZINDEX, {
                            id: n,
                            zIndex: e.rects.length
                        });
                        for (let r = 0, i = e.rects.length; r < i; r++)
                            if (r !== n) {
                                if (1 === e.rects[r].zIndex)
                                    continue;
                                t(qt.CHANGE_ZINDEX, {
                                    id: r,
                                    zIndex: e.rects[r].zIndex - 1
                ...
                setMinWidth({commit: t}, {id: e, width: n}) {
                    t(qt.CHANGE_MINW, {
                        id: e,
                        minw: n
                    })
                },
                setMinHeight({commit: t}, {id: e, height: n}) {
                    t(qt.CHANGE_MINH, {
                        id: e,
                        minh: n
                    })
              ...
              , Ht = {
                getActive: t => {
                    for (let e = 0, n = t.rects.length; e < n; e++) {
                        let n = t.rects[e];
                        if (n.active)
                            return e
                    }
              ...
              , Zt = {
                ...
                [Lt](t, e) {
                    t.rects[e].aspectRatio = !0
                },
                [Gt](t, e) {
                    t.rects[e].aspectRatio = !1
                },
                [Ct](t, e) {
                    t.rects[e].draggable = !0
                },
                [St](t, e) {
                    t.rects[e].draggable = !1
                },
                [kt](t, e) {
                    t.rects[e].resizable = !0
                },
                [Ot](t, e) {
                    t.rects[e].resizable = !1
                },
                [Et](t, e) {
                    t.rects[e].snapToGrid = !0
                },
                [Dt](t, e) {
                    t.rects[e].snapToGrid = !1
                },
                [Mt](t, e) {
                    t.rects[e].axis = "both"
                },
                ...
                [Tt](t, e) {
                    t.rects[e].parentLim = !0
                },
                [It](t, e) {
                    t.rects[e].parentLim = !1
                },
                [Bt](t, e) {
                    t.rects[e.id].zIndex = e.zIndex
                },
                [Qt](t, e) {
                    t.rects[e.id].height = e.height
                },
                [zt](t, e) {
                    t.rects[e.id].width = e.width
                },
                [Wt](t, e) {
                    t.rects[e.id].top = e.top
                },
                [Ft](t, e) {
                    t.rects[e.id].left = e.left
                },
                [Pt](t, e) {
                    t.rects[e.id].minh = e.minh
                },
                [Vt](t, e) {
                    t.rects[e.id].minw = e.minw
                }
            }
              , Jt = {
                rects: [{
            ...
            var Kt = Yt;
            const _t = "ENABLE_ACTIVE"
              , $t = "DISABLE_ACTIVE"
              , te = "UPDATE_CHART_ITEM"
              , ee = "UPDATE_CHART_ITEM_CHARTLIST"
              , ne = "UPDATE_CHART_ITEM_ONE"
              , re = "UPDATE_CHART_ITEM_CHARTLIST_ONE";
            var ie = {
                ENABLE_ACTIVE: _t,
                DISABLE_ACTIVE: $t,
                UPDATE_CHART_ITEM: te,
                UPDATE_CHART_ITEM_CHARTLIST: ee,
                UPDATE_CHART_ITEM_ONE: ne,
                UPDATE_CHART_ITEM_CHARTLIST_ONE: re
            }
              , ae = {
                setActive({commit: t, state: e}, {id: n}) {
                    for (let r = 0, i = e.chartLists.length; r < i; r++)
                        t(r !== n ? ie.DISABLE_ACTIVE : ie.ENABLE_ACTIVE, r)
                },
                unsetActive({commit: t}, {id: e}) {
                    t(ie.DISABLE_ACTIVE, e)
                },
                updateChartItem({commit: t}, e) {
                    t(ie.UPDATE_CHART_ITEM, e)
                },
                updateChartItemChartlist({commit: t}, e) {
                    t(ie.UPDATE_CHART_ITEM_CHARTLIST, e)
                },
                updateChartItemOne({commit: t}, e) {
                    t(ie.UPDATE_CHART_ITEM_ONE, e)
                },
                updateChartItemChartlistOne({commit: t}, e) {
                    t(ie.UPDATE_CHART_ITEM_CHARTLIST_ONE, e)
                }
            }
              , oe = {
                getActive: t => {
                    for (let e = 0, n = t.chartLists.length; e < n; e++) {
                        let n = t.chartLists[e];
                        if (n.active)
                            return e
                    }
                    return null
              ...
              , se = {
                [_t](t, e) {
                    t.chartLists[e].active = !0,
                    t.currentChartIndex = e
                },
                [$t](t, e) {
                    t.chartLists[e].active = !1
                },
                [te](t, e) {
                    const {router: n, updateObj: r} = e
                      , i = t.chartLists[t.currentChartIndex].chartOptions;
                    pe(i, n, r)
                },
                [ee](t, e) {
                    let n = t.chartLists.findIndex(t => t.chart_id == e.chart_id);
                    t.chartLists[n].chartOptions = h.a.extend(t.chartLists[n].chartOptions, e)
                },
                [re](t, e) {
                    let n = t.chartLists.findIndex(t => t.chart_id == e.chart_id);
                    t.chartLists[n].chartOptions[e.key] = e.value
                },
                [ne](t, e) {
                    t[e.key] = e.value
                }
            ...
            const fe = n("164e")
              , pe = function(t, e, n) {
                if (void 0 == t || void 0 == e)
                    return t;
                let r = e.split("/");
                const i = t.defaultOption;
                function a(t) {
                    return 0 != r.length ? a(t[r.shift()]) : (Object.assign(t, n),
                    t)
                }
                return a(i),
                de({
              ...
              , de = function(t, e) {
                let n = t.chartOptions
                  , r = n.chart_id;
                const i = n.chartAllType.split("|")
                  , a = i[0]
                  , o = document.getElementById(r);
                if (o && "echarts" === a) {
                    const t = vt(n);
                    let e = fe.getInstanceByDom(o);
                    null == e && (e = fe.init(o)),
                    e.setOption(t, !0),
                    setTimeout( () => {
                        fe.getInstanceById(o.getAttribute("_echarts_instance_")).resize()
                    }
                    , 0)
                }
            }
              , ge = function(t, e, n, r) {
                let i = ["bold", "vertical", "italic"];
                t.label.fontGroup.forEach(a => {
                    if (i.includes(a))
                        switch (a) {
                        case "bold":
                            e[n].fontWeight = a;
                ...
                e[n].fontSize = ve(t.label.fontSize, t.label.cusFontSize)
            }
              , me = function() {
                function t(t) {
                ...
                function n(t, r, i) {
                    ...
                    switch (i) {
                    case "add":
                        return f = c === u ? s + l : c > u ? s + l * (c / u) : s * (u / c) + l,
                        f / h;
                    case "subtract":
                        return f = c === u ? s - l : c > u ? s - l * (c / u) : s * (u / c) - l,
                        f / h;
              ...
              , ye = function(t, e) {
                ...
                i.chart_id = r,
                i.chartAllType = e;
                var c = t.defaultOption;
                c.series = [];
                var u = H(t.chartData, t.rangeSplitArray, o, s, l);
                i.chartDataCache = u;
                var h = Z(u.series[0].length);
                i.chartDataSeriesOrder = h;
                var f = J(c, u, h, o, s, l, t.chartData);
                i.defaultOption = f,
                he.dispatch("chartSetting/updateChartItemChartlist", i),
                de({
                    chartOptions: i,
                    chart_id: r
                })
              ...
              , xe = function(t, e, n, r) {
                var i = he.state
                  , a = L(i.chartSetting.chartLists[i.chartSetting.currentChartIndex].chartOptions);
                a.chart_id = t,
                a.rangeRowCheck = e,
                a.rangeColCheck = n,
                a.rangeConfigCheck = r,
                a.chartData = a.chartData || [],
                a.rangeSplitArray = q(a.chartData, a.rangeArray, n, e);
                var o = a.chartAllType.split("|")
                  , s = o[0]
                  , l = o[1]
                  , c = o[2];
                a.chartDataCache = H(a.chartData, a.rangeSplitArray, s, l, c, r),
                a.chartDataSeriesOrder = Z(a.chartDataCache.series[0].length),
                a.defaultOption = J(a.defaultOption, a.chartDataCache, a.chartDataSeriesOrder, s, l, c),
                he.dispatch("chartSetting/updateChartItemChartlist", a),
                de({
                    chartOptions: a,
                    chart_id: t
                })
              ...
              , Ae = function(t, e) {
                if (null != t) {
                    var n = t.chart_id
                      , r = t.chartAllType.split("|")
                      , i = r[0]
                      , a = r[1]
                      , o = r[2];
                    t.defaultOption = J(t.defaultOption, t.chartDataCache, e, i, a, o),
                    he.dispatch("chartSetting/updateChartItemChartlist", t),
                    de({
                        chartOptions: t,
                        chart_id: n
                    })
            ...
            function we(t, e, n, r) {
                let i = he.state.chartSetting.chartLists.findIndex(e => e.chart_id == t);
                he.state.chartSetting.currentChartIndex = i;
                var a = he.state.chartSetting.chartLists[i].chartOptions
                  , o = a.chartAllType
                  , s = o.split("|")
                  , l = s[0]
                  , c = s[1]
                ...
                a.rangeColCheck = p,
                a.rangeRowCheck = f,
                a.rangeConfigCheck = d;
                var g = q(e, n, p, f);
                a.rangeSplitArray = g;
                var m = H(e, g, l, c, u);
                a.chartDataCache = m;
                var b = Z(m.series[0].length);
                a.chartDataSeriesOrder = b;
                var v = a.defaultOption
                  , y = J(v, m, b, l, c, u, !0, e);
                a.defaultOption = y,
                he.dispatch("chartSetting/updateChartItemChartlist", a),
                de({
            ...
            function Ce(t, e) {
                let n = he.state.chartSetting.chartLists.findIndex(e => e.chart_id == t);
                he.state.chartSetting.currentChartIndex = n;
                var r = he.state.chartSetting.chartLists[n].chartOptions
                  , i = r.chartAllType
                  , a = i.split("|")
                  , o = a[0]
                  , s = a[1]
                  , l = a[2];
                r.chartData = e;
                var c = r.rangeRowCheck
                  , u = r.rangeColCheck
                  , h = q(e, r.rangeArray, u, c);
                r.rangeSplitArray = h;
                var f = H(e, h, o, s, l);
                r.chartDataCache = f;
                var p = Z(f.series[0].length);
                r.chartDataSeriesOrder = p;
                var d = r.defaultOption
                  , g = J(d, f, p, o, s, l, !0, e);
                r.defaultOption = g,
                he.dispatch("chartSetting/updateChartItemChartlist", r),
                de({
                    chartOptions: r,
                    chart_id: t
                })
            ...
            var Ie = Te
              , Ee = {
                ...
                mounted() {
                    if ("ch" == this.lang)
                        return this.config[0].data = this.echartsCN,
                        this.close = "关闭图表选择菜单",
                        void this.chooseConfig();
                    this.config[0].data = this.echartsEN,
                    this.close = "close chart-select menu",
                    this.chooseConfig()
                },
                computed: {
                    ...Object(f["mapState"])("chartSetting", ["chartLists", "currentChartIndex"]),
                    chartPro() {
                ...
                methods: {
                    chooseConfig() {
                        for (var t = 0; t < this.config.length; t++)
                            if (this.config[t].type == this.chartPro)
                                return void (this.currentConfig = this.config[t]);
                        this.currentConfig = this.config[0]
                    },
                    changeChartType: function(t) {
                        return null == this.currentChartIndex ? null : (this.chartLists[this.currentChartIndex].chartOptions,
                        Se["chartreuse"] == t ? null : (ye(L(this.chartLists[this.currentChartIndex].chartOptions), t),
                        this.$emit("closeChartShowList"),
                        void (this.currentChartType = t)))
                    },
                    quickListScroll: function(t) {
                        var e = h()(t.currentTarget).scrollTop()
                          , n = this;
                        h()(t.currentTarget).find("div.luckysheet-datavisual-quick-list-title").each((function() {
                            var t = h()(this)
                              , r = t.position();
                            if (e >= n.list_scroll_direction) {
                                if (r.top + 55 > 0)
                                    return h()("#luckysheet-datavisual-quick-menu div").removeClass("luckysheet-datavisual-quick-menu-active"),
                                    h()("#luckysheet-datavisual-chart-menu-" + t.find("a").data("type")).addClass("luckysheet-datavisual-quick-menu-active"),
                                    !1
                            } else if (r.top - 55 >= 0) {
                                h()("#luckysheet-datavisual-quick-menu div").removeClass("luckysheet-datavisual-quick-menu-active");
                                var i = t.prev().prev();
                                return 0 == i.length && (i = t),
                                h()("#luckysheet-datavisual-chart-menu-" + i.find("a").data("type")).addClass("luckysheet-datavisual-quick-menu-active"),
                                !1
                            }
                            setTimeout((function() {
                                n.list_scroll_direction = e
                            }
                            ), 0)
                        }
                        ))
                    },
                    quickMenu: function(t) {
                        var e = h()(t.currentTarget);
                        h()("#luckysheet-datavisual-quick-menu div").removeClass("luckysheet-datavisual-quick-menu-active"),
                        e.addClass("luckysheet-datavisual-quick-menu-active");
                        var n = h()("#luckysheet-datavisual-chart-listtitle-" + e.data("type")).parent()
                          , r = n.position().top;
                        h()("#luckysheet-datavisual-quick-list").scrollTop(r + 5 + h()("#luckysheet-datavisual-quick-list").scrollTop())
                    }
                }
            }
              , De = Ee;
            n("d81a");
            function Le(t, e, n, r, i, a, o, s) {
            ...
            var Ge = Le(De, l, c, !1, null, null, null)
              , je = Ge.exports
              , Ne = n("63ea")
              , Me = n.n(Ne)
              , Re = function() {
                ...
                return e("el-collapse-item", {
                    ...
                    slot: "title"
                }, [t._v(" " + t._s(t.setItem.modalName) + " "), e("i", {
                    staticClass: "iconfont icon-biaoti"
                })]), e("chart-base-switch", {
                    attrs: {
                        switchValue: t.title.show
                    },
                    on: {
                        "update:switchValue": function(e) {
                            return t.$set(t.title, "show", e)
                        },
                        "update:switch-value": function(e) {
                            return t.$set(t.title, "show", e)
                        }
                    }
                }, [e("div", {
                    ...
                    slot: "title"
                }, [t._v(t._s(t.setItem.show))])]), e("chart-base-input", {
                    attrs: {
                        inputValue: t.title.text,
                        placeholder: t.setItem.placeholder
                    },
                    on: {
                        "update:inputValue": function(e) {
                            return t.$set(t.title, "text", e)
                        },
                        "update:input-value": function(e) {
                            return t.$set(t.title, "text", e)
                        }
                    }
                }, [e("div", {
                    ...
                    slot: "input"
                }, [t._v(t._s(t.setItem.text))])]), e("chart-base-label", {
                    attrs: {
                        router: t.router + "/label",
                        baseLabelOption: t.title.label
                    },
                    on: {
                        "update:baseLabelOption": function(e) {
                            return t.$set(t.title, "label", e)
                        },
                        "update:base-label-option": function(e) {
                            return t.$set(t.title, "label", e)
                        }
                    }
                }, [e("div", {
                    ...
                    slot: "title"
                }, [t._v(t._s(t.setItem.label))])]), e("chart-base-select", {
                    attrs: {
                        selectOption: t.positionData,
                        selectValue: t.title.position.value
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.title.position, "value", e)
                        },
                    ...
                    slot: "select"
                }, [t._v(t._s(t.setItem.position))])]), "custom" === t.title.position.value ? e("el-row", [e("chart-base-slider", {
                    attrs: {
                        baseSliderOption: t.title.position.offsetX,
                        unit: "%",
                        content: t.setItem.offsetL
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.title.position, "offsetX", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.title.position, "offsetX", e)
                        }
                    }
                }), e("chart-base-slider", {
                    attrs: {
                        baseSliderOption: t.title.position.offsetY,
                        unit: "%",
                        content: t.setItem.offsetT
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.title.position, "offsetY", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.title.position, "offsetY", e)
                        }
              ...
              , Ve = function() {
                ...
                return e("div", [e("el-row", {
                ...
                }, [t._t("title")], 2), e("el-col", {
                    attrs: {
                        span: 16
                    }
                }, [e("chart-base-box", {
                    attrs: {
                        boxData: t.baseLabelOptionData.fontGroup,
                        checkboxOption: t.fontStyleObj
                    },
                    on: {
                        "update:boxData": function(e) {
                            return t.$set(t.baseLabelOptionData, "fontGroup", e)
                        },
                        "update:box-data": function(e) {
                            return t.$set(t.baseLabelOptionData, "fontGroup", e)
                        }
                    }
                }), e("el-row", {
                    ...
                    attrs: {
                        hideCol: !0,
                        tooltip: "选择字体大小",
                        selectOption: t.fontSizeList,
                        selectValue: t.baseLabelOptionData.fontSize
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.baseLabelOptionData, "fontSize", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.baseLabelOptionData, "fontSize", e)
                        }
                    ...
                    on: {
                        change: t.changeStyle
                    },
                    model: {
                        value: t.baseLabelOptionData.color,
                        callback: function(e) {
                            t.$set(t.baseLabelOptionData, "color", e)
                        },
                        expression: "baseLabelOptionData.color"
                    }
                })], 1)], 1)], 1)], 1), "custom" === t.baseLabelOptionData.fontSize ? e("chart-base-slider", {
                    attrs: {
                        baseSliderOption: t.baseLabelOptionData.cusFontSize,
                        unit: "px",
                        content: "滑动修改字体大小"
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.baseLabelOptionData, "cusFontSize", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.baseLabelOptionData, "cusFontSize", e)
                        }
              ...
              , ze = {
                ...
                components: {
                    "chart-base-slider": dn,
                    "chart-base-select": ln,
                    "chart-base-box": xn
                },
                data: function() {
                    return {
                ...
                watch: {
                    baseLabelOption: {
                        handler: function(t) {
                            Me.a(this.baseLabelOptionData, t) || (this.baseLabelOptionData = L(t),
                            this.router.includes("title") ? this.fontStyleObj = L(T) : this.fontStyleObj = L(I))
                        },
                        immediate: !0,
                        deep: !0
                    },
                ...
                methods: {
                    ...f["mapActions"]("chartSetting", ["updateChartItem"]),
                    changeStyle() {
                        const t = {
                            updateObj: L(this.baseLabelOptionData),
                            router: this.router
                        };
                        this.updateChartItem(t)
                    }
                }
            }
              , Qe = ze
              , We = Le(Qe, Ve, Pe, !1, null, null, null)
              , Fe = We.exports
              , qe = function() {
                var t = this
                  , e = t._self._c;
              ...
              , He = {
                ...
                mounted() {
                    this.switchData = !!this.switchValue && this.switchValue
                },
                methods: {
                    changeSwitch(t) {
                        this.$emit("update:switchValue", t)
                    }
                }
            }
              , Ze = He
              , Je = Le(Ze, qe, Xe, !1, null, null, null)
              , Ue = Je.exports
              , Ye = function() {
                var t = this
                  , e = t._self._c;
                return e("div", [t.hideCol ? e("el-input", {
                    attrs: {
              ...
              , $e = _e
              , tn = Le($e, Ye, Ke, !1, null, null, null)
              , en = tn.exports
              , nn = function() {
                var t = this
                  , e = t._self._c;
                return t.hideCol ? e("el-tooltip", {
                    attrs: {
                        disabled: !t.tooltip,
                        "open-delay": 500,
                        content: t.tooltip,
                ...
                }, t._l(t.selectOption, (function(t, n) {
                    return e("el-option", {
                        key: n,
                        attrs: {
                            label: t.label,
              ...
              , an = {
                ...
                methods: {
                    changeSelect(t) {
                        this.$emit("update:selectValue", t)
                    }
                }
            }
              , on = an
              , sn = Le(on, nn, rn, !1, null, null, null)
              , ln = sn.exports
              , cn = function() {
                var t = this
                  , e = t._self._c;
                return e("div", [t.hideCol ? e("el-row", {
                    ...
                    attrs: {
                        ...
                        "input-size": "mini",
                        "show-input": "",
                        "format-tooltip": t.format ? t.formatter : null
                    },
                    on: {
                        change: t.handlerChange
                    },
                    model: {
                        value: t.baseSliderData,
                        callback: function(e) {
                            t.baseSliderData = e
                        },
              ...
              , hn = {
                ...
                methods: {
                    handlerChange(t) {
                        this.$emit("update:baseSliderOption", t)
                    },
                    formatter(t) {
                        return null
                    }
              ...
              , fn = hn
              , pn = (n("8ce1"),
            Le(fn, cn, un, !1, null, null, null))
              , dn = pn.exports
              , gn = function() {
                var t = this
                  , e = t._self._c;
                return e("el-row", [e("el-checkbox-group", {
                    attrs: {
                        size: "mini"
                    },
                    on: {
                ...
                }, t._l(t.checkboxOption, (function(n, r) {
                    return e("el-tooltip", {
                        key: r,
                        attrs: {
                            "open-delay": 500,
              ...
              , bn = {
                ...
                mounted() {
                    this.boxValue = this.boxData ? L(this.boxData) : []
                },
                methods: {
                    changeStyle(t) {
                        this.$emit("update:boxData", t)
                    }
                }
            }
              , vn = bn
              , yn = Le(vn, gn, mn, !1, null, null, null)
              , xn = yn.exports;
            const An = function(t) {
                return {
            ...
            var wn = {
                ...
                mounted() {
                    "ch" != this.lang ? this.setItem = Ie["chartTitle"] : this.setItem = Oe["chartTitle"]
                },
                data: function() {
                    return {
                        title: "",
                ...
                watch: {
                    titleOption: {
                        handler: function(t, e) {
                            Me.a(this.title, t) || (e && (this.isChange = !0),
                            this.title = L(t))
                        },
                        deep: !0,
                        immediate: !0
                    ...
                    title: {
                        handler: function(t, e) {
                            this.isChange ? this.isChange = !this.isChange : e && this.changeTitle()
                        },
                        deep: !0,
                        immediate: !0
                    },
                    lang(t) {
                        this.setItem = "ch" != t ? Ie["chartTitle"] : Oe["chartTitle"]
                    }
                },
                methods: {
                    ...f["mapActions"]("chartSetting", ["updateChartItem"]),
              ...
              , Cn = wn
              , Sn = Le(Cn, Re, Be, !1, null, null, null)
              , kn = Sn.exports
              , On = function() {
                var t = this
                  , e = t._self._c;
                return e("el-collapse-item", {
                    ...
                    attrs: {
                        inputValue: t.subTitle.text,
                        placeholder: t.setItem.placeholder
                    },
                    on: {
                        "update:inputValue": function(e) {
                            return t.$set(t.subTitle, "text", e)
                        },
                        "update:input-value": function(e) {
                            return t.$set(t.subTitle, "text", e)
                        }
                    ...
                    attrs: {
                        router: t.router + "/label",
                        baseLabelOption: t.subTitle.label
                    }
                }, [e("div", {
                    attrs: {
                        slot: "title"
                    ...
                    attrs: {
                        selectOption: t.distanceOption,
                        selectValue: t.subTitle.distance.value
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.subTitle.distance, "value", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.subTitle.distance, "value", e)
                        }
                    ...
                    slot: "select"
                }, [t._v(t._s(t.setItem.gap))])]), "custom" === t.subTitle.distance.value ? e("chart-base-slider", {
                    attrs: {
                        baseSliderOption: t.subTitle.distance.cusGap,
                        unit: "px",
                        content: t.setItem.content
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.subTitle.distance, "cusGap", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.subTitle.distance, "cusGap", e)
                        }
              ...
              , In = {
                ...
                mounted() {
                    "ch" != this.lang ? this.setItem = Ie["chartSubTitle"] : this.setItem = Oe["chartSubTitle"]
                },
                watch: {
                    subTitleOption: {
                        handler: function(t) {
                            Me.a(this.subTitle, t) || (this.subTitle = L(t))
                        },
                        immediate: !0,
                        deep: !0
                    },
                    ...
                    lang(t) {
                        this.setItem = "ch" != t ? Ie["chartSubTitle"] : Oe["chartSubTitle"]
                    }
                },
                methods: {
                    ...f["mapActions"]("chartSetting", ["updateChartItem"]),
              ...
              , En = In
              , Dn = Le(En, On, Tn, !1, null, null, null)
              , Ln = Dn.exports
              , Gn = function() {
                var t = this
                  , e = t._self._c;
                return e("el-collapse-item", {
                    ...
                    attrs: {
                        switchValue: t.cursor.show
                    },
                    on: {
                        "update:switchValue": function(e) {
                            return t.$set(t.cursor, "show", e)
                        },
                        "update:switch-value": function(e) {
                            return t.$set(t.cursor, "show", e)
                        }
                    ...
                    slot: "title"
                }, [t._v(t._s(t.setItem.show))])]), e("chart-base-label", {
                    attrs: {
                        router: t.router + "/label",
                        baseLabelOption: t.cursor.label
                    }
                }, [e("div", {
                    attrs: {
                        slot: "title"
                    ...
                    slot: "title"
                }, [t._v(t._s(t.setItem.label))])]), e("el-row", {
                    staticStyle: {
                        "margin-top": "10px"
                    }
                }, [e("el-col", {
                ...
                }, [t._v(t._s(t.setItem.background))]), e("el-col", {
                    attrs: {
                        span: 3
                    }
                }, [e("el-color-picker", {
                    ...
                    model: {
                        value: t.cursor.backgroundColor,
                        callback: function(e) {
                            t.$set(t.cursor, "backgroundColor", e)
                        },
                        expression: "cursor.backgroundColor"
                    }
                })], 1)], 1), e("chart-base-select", {
                    attrs: {
                        selectOption: t.triggerMethodArr,
                        selectValue: t.cursor.triggerOn
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.cursor, "triggerOn", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.cursor, "triggerOn", e)
                        }
                    ...
                    slot: "select"
                }, [t._v(t._s(t.setItem.trigger))])]), e("chart-base-select", {
                    attrs: {
                        selectOption: t.triggerTypeArr,
                        selectValue: t.cursor.triggerType
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.cursor, "triggerType", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.cursor, "triggerType", e)
                        }
                    ...
                    slot: "select"
                }, [t._v(t._s(t.setItem.type))])]), "item" != t.cursor.triggerType ? e("div", [e("chart-base-select", {
                    attrs: {
                        selectOption: t.lineStyleOption,
                        selectValue: t.cursor.axisPointer.style.type
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.cursor.axisPointer.style, "type", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.cursor.axisPointer.style, "type", e)
                        }
                    ...
                    slot: "select"
                }, [t._v(t._s(t.setItem.lineType))])]), e("chart-base-select", {
                    attrs: {
                        selectOption: t.lineWeightOption,
                        selectValue: t.cursor.axisPointer.style.width
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.cursor.axisPointer.style, "width", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.cursor.axisPointer.style, "width", e)
                        }
                    ...
                    slot: "select"
                }, [t._v(t._s(t.setItem.lineWidth))])]), e("el-row", {
                    staticStyle: {
                        "margin-top": "15px"
                    }
                }, [e("el-col", {
                ...
                }, [t._v(t._s(t.setItem.color))]), e("el-col", {
                    attrs: {
                        span: 3
                    }
                }, [e("el-color-picker", {
                    ...
                    model: {
                        value: t.cursor.axisPointer.style.color,
                        callback: function(e) {
                            t.$set(t.cursor.axisPointer.style, "color", e)
                        },
                        expression: "cursor.axisPointer.style.color"
                    }
                })], 1)], 1), e("chart-base-select", {
                    attrs: {
                        selectOption: t.axisPointerArr,
                        selectValue: t.cursor.axisPointer.type
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.cursor.axisPointer, "type", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.cursor.axisPointer, "type", e)
                        }
                    ...
                    slot: "select"
                }, [t._v(t._s(t.setItem.axisType))])])], 1) : t._e(), "item" == t.cursor.triggerType ? e("chart-base-select", {
                    attrs: {
                        selectOption: t.posOption,
                        selectValue: t.cursor.position
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.cursor, "position", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.cursor, "position", e)
                        }
                    ...
                    slot: "select"
                }, [t._v(t._s(t.setItem.position))])]) : t._e(), e("el-row", {
                    staticStyle: {
                        "margin-top": "15px"
                    }
                }, [e("el-col", {
                ...
                }, [t._v(t._s(t.setItem.suffix))])], 1), t._l(t.seriesOption, (function(n, r) {
                    return e("el-row", {
                        key: r,
                        staticStyle: {
                            "margin-top": "15px"
                        ...
                        attrs: {
                            tooltip: t.setItem.ratio,
                            selectOption: t.ratioOption,
                            selectValue: t.cursor.format[r].ratio,
                            hideCol: !0
                        },
                        on: {
                            "update:selectValue": function(e) {
                                return t.$set(t.cursor.format[r], "ratio", e)
                            },
                            "update:select-value": function(e) {
                                return t.$set(t.cursor.format[r], "ratio", e)
                            }
                        ...
                        attrs: {
                            tooltip: t.setItem.digit,
                            selectOption: t.digitOption,
                            selectValue: t.cursor.format[r].digit,
                            hideCol: !0
                        },
                        on: {
                            "update:selectValue": function(e) {
                                return t.$set(t.cursor.format[r], "digit", e)
                            },
                            "update:select-value": function(e) {
                                return t.$set(t.cursor.format[r], "digit", e)
                            }
              ...
              , Nn = {
                ...
                data() {
                    return {
                        ...
                        fontSizeOption: L(v),
                        lineStyleOption: L(y),
                        lineWeightOption: L(x),
                        posOption: L(A),
                        ratioOption: L(w),
                        digitOption: L(C),
                        triggerTypeArr: [{
                            value: "item",
                            label: "Data item graphic trigger"
                        }, {
                            value: "axis",
                            label: "Axis trigger"
                        }],
                        axisPointerArr: [{
                            ...
                            value: "shadow",
                            label: "Shadow indicator"
                        }, {
                            value: "cross",
                            label: "Crosshair indicator"
                        }],
                        triggerMethodArr: [{
                            value: "mousemove",
                            ...
                            label: "Trigger Simultaneously"
                        }],
                        setItem: {}
                    }
                },
                mounted() {
                    "ch" != this.lang ? this.setItem = Ie["chartCursor"] : this.setItem = Oe["chartCursor"]
                },
                watch: {
                    cursorOption: {
                        handler(t) {
                            Me.a(this.cursor, t) || (this.cursor = L(t))
                        },
                        immediate: !0,
                        deep: !0
                    },
                    ...
                    lang(t) {
                        this.setItem = "ch" != t ? Ie["chartCursor"] : Oe["chartCursor"]
                    }
                },
                computed: {
                    seriesOption() {
                        for (var t = [], e = 0; e < this.cursor.format.length; e++)
                            t.push(this.cursor.format[e].seriesName);
                        return t
                    }
                },
                methods: {
              ...
              , Mn = Nn
              , Rn = Le(Mn, Gn, jn, !1, null, null, null)
              , Bn = Rn.exports
              , Vn = function() {
                var t = this
                  , e = t._self._c;
                return e("el-collapse-item", {
                    ...
                    attrs: {
                        switchValue: t.legend.show
                    },
                    on: {
                        "update:switchValue": function(e) {
                            return t.$set(t.legend, "show", e)
                        },
                        "update:switch-value": function(e) {
                            return t.$set(t.legend, "show", e)
                        }
                    ...
                    attrs: {
                        router: t.router + "/label",
                        baseLabelOption: t.legend.label
                    },
                    on: {
                        "update:baseLabelOption": function(e) {
                            return t.$set(t.legend, "label", e)
                        },
                        "update:base-label-option": function(e) {
                            return t.$set(t.legend, "label", e)
                        }
                    ...
                    slot: "title"
                }, [t._v("Legend Style")])]), e("chart-base-select", {
                    attrs: {
                        selectOption: t.positionOption,
                        selectValue: t.legend.position.value
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.legend.position, "value", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.legend.position, "value", e)
                        }
                    ...
                    slot: "select"
                }, [t._v("Legend Position")])]), "custom" === t.legend.position.value ? e("el-row", [e("chart-base-slider", {
                    attrs: {
                        baseSliderOption: t.legend.position.offsetX,
                        unit: "%",
                        content: "滑动修改水平偏移量"
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.legend.position, "offsetX", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.legend.position, "offsetX", e)
                        }
                    ...
                    attrs: {
                        baseSliderOption: t.legend.position.offsetY,
                        unit: "%",
                        content: "滑动修改垂直偏移量"
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.legend.position, "offsetY", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.legend.position, "offsetY", e)
                        }
                    }
                })], 1) : t._e(), e("chart-base-select", {
                    attrs: {
                        selectOption: t.dirOptions,
                        selectValue: t.legend.position.direction
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.legend.position, "direction", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.legend.position, "direction", e)
                        }
                    ...
                    slot: "select"
                }, [t._v("Legend Orientation")])]), e("chart-base-select", {
                    attrs: {
                        selectOption: t.sizeOption,
                        selectValue: t.legend.width.value
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.legend.width, "value", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.legend.width, "value", e)
                        }
                    ...
                    slot: "select"
                }, [t._v("Legend Width")])]), e("chart-base-select", {
                    attrs: {
                        selectOption: t.sizeOption,
                        selectValue: t.legend.height.value
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.legend.height, "value", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.legend.height, "value", e)
                        }
                    ...
                    slot: "select"
                }, [t._v("Legend Height")])]), "custom" == t.legend.width.value ? e("chart-base-slider", {
                    attrs: {
                        baseSliderOption: t.legend.width.cusSize,
                        unit: "px",
                        content: "滑动修改图例宽度"
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.legend.width, "cusSize", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.legend.width, "cusSize", e)
                        }
                    }
                }) : t._e(), "custom" == t.legend.height.value ? e("chart-base-slider", {
                    attrs: {
                        baseSliderOption: t.legend.height.cusSize,
                        unit: "px",
                        content: "滑动修改图例高度"
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.legend.height, "cusSize", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.legend.height, "cusSize", e)
                        }
                    }
                }) : t._e(), e("chart-base-select", {
                    attrs: {
                        selectOption: t.distanceOption,
                        selectValue: t.legend.distance.value
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.legend.distance, "value", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.legend.distance, "value", e)
                        }
                    ...
                    slot: "select"
                }, [t._v("Legend Spacing")])]), "custom" == t.legend.distance.value ? e("chart-base-slider", {
                    attrs: {
                        baseSliderOption: t.legend.distance.cusGap,
                        unit: "px",
                        content: "滑动修改图例间距"
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.legend.distance, "cusGap", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.legend.distance, "cusGap", e)
                        }
              ...
              , zn = {
                ...
                mounted() {
                    "ch" != this.lang ? this.setItem = Ie["chartLegend"] : this.setItem = Oe["chartLegend"]
                },
                watch: {
                    legendOption: {
                        handler(t) {
                            Me.a(this.legend, t) || (this.legend = L(t))
                        },
                        immediate: !0,
                        deep: !0
                    },
                    ...
                    lang(t) {
                        this.setItem = "ch" != t ? Ie["chartLegend"] : Oe["chartLegend"]
                    }
                },
                methods: {
                    ...f["mapActions"]("chartSetting", ["updateChartItem"]),
              ...
              , Qn = zn
              , Wn = Le(Qn, Vn, Pn, !1, null, null, null)
              , Fn = Wn.exports
              , qn = function() {
                var t = this
                  , e = t._self._c;
                return e("el-collapse-item", {
                    ...
                    attrs: {
                        selectOption: t.axisGroup,
                        selectValue: t.axis.axisType
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.axis, "axisType", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.axis, "axisType", e)
                        }
                    ...
                    slot: "select"
                }, [t._v(t._s(t.setItem.select))])]), e("chart-base-switch", {
                    attrs: {
                        switchValue: t.series.show
                    },
                    on: {
                        "update:switchValue": function(e) {
                            return t.$set(t.series, "show", e)
                        },
                        "update:switch-value": function(e) {
                            return t.$set(t.series, "show", e)
                        }
                    ...
                    attrs: {
                        inputValue: t.series.title.text,
                        placeholder: t.setItem.placeholder
                    },
                    on: {
                        "update:inputValue": function(e) {
                            return t.$set(t.series.title, "text", e)
                        },
                        "update:input-value": function(e) {
                            return t.$set(t.series.title, "text", e)
                        }
                    ...
                    slot: "input"
                }, [t._v(t._s(t.setItem.text))])]), e("div", {
                    directives: [{
                        name: "show",
                        rawName: "v-show",
                        value: t.series.title.text,
                    ...
                    attrs: {
                        router: t.router + "/label",
                        baseLabelOption: t.series.title.label
                    },
                    on: {
                        "update:baseLabelOption": function(e) {
                            return t.$set(t.series.title, "label", e)
                        },
                        "update:base-label-option": function(e) {
                            return t.$set(t.series.title, "label", e)
                        }
                    ...
                    attrs: {
                        selectOption: t.fzPosOption,
                        selectValue: t.series.title.fzPosition
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.series.title, "fzPosition", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.series.title, "fzPosition", e)
                        }
                    ...
                    slot: "select"
                }, [t._v(t._s(t.setItem.align))])])], 1), e("chart-base-switch", {
                    attrs: {
                        switchValue: t.series.inverse
                    },
                    on: {
                        "update:switchValue": function(e) {
                            return t.$set(t.series, "inverse", e)
                        },
                        "update:switch-value": function(e) {
                            return t.$set(t.series, "inverse", e)
                        }
                    ...
                    slot: "title"
                }, [t._v(t._s(t.setItem.reverse))])]), e("chart-base-slider", {
                    attrs: {
                        hideCol: !0,
                        max: 10,
                        baseSliderOption: t.series.tickLabel.optimize,
                        unit: "个",
                        content: t.setItem.content
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.series.tickLabel, "optimize", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.series.tickLabel, "optimize", e)
                        }
                    ...
                    slot: "title"
                }, [t._v(t._s(t.setItem.intenval))])]), e("div", {
                    directives: [{
                        name: "show",
                        rawName: "v-show",
                        value: t.series.title.text,
                    ...
                    attrs: {
                        hideCol: !0,
                        baseSliderOption: t.series.title.nameGap,
                        unit: "px",
                        content: t.setItem.content1
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.series.title, "nameGap", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.series.title, "nameGap", e)
                        }
                    ...
                    slot: "title"
                }, [t._v(t._s(t.setItem.gap))])]), e("chart-base-slider", {
                    attrs: {
                        hideCol: !0,
                        format: t.formatRotation + "",
                        max: 180,
                        min: -180,
                        baseSliderOption: t.series.title.rotate,
                        unit: "°",
                        content: t.setItem.content2
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.series.title, "rotate", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.series.title, "rotate", e)
                        }
                    ...
                    slot: "title"
                }, [t._v(t._s(t.setItem.title))])])], 1), e("chart-base-switch", {
                    attrs: {
                        switchValue: t.series.tickLine.show
                    },
                    on: {
                        "update:switchValue": function(e) {
                            return t.$set(t.series.tickLine, "show", e)
                        },
                        "update:switch-value": function(e) {
                            return t.$set(t.series.tickLine, "show", e)
                        }
                    ...
                    slot: "title"
                }, [t._v(t._s(t.setItem.showLine))])]), e("chart-base-slider", {
                    attrs: {
                        hideCol: !0,
                        min: 1,
                        baseSliderOption: t.series.tickLine.width,
                        unit: "px",
                        content: t.setItem.content3
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.series.tickLine, "width", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.series.tickLine, "width", e)
                        }
                ...
                }, [t._v(t._s(t.setItem.lineColor))]), e("el-col", {
                    attrs: {
                        push: 14,
                        span: 3
                    }
                    ...
                    model: {
                        value: t.series.tickLine.color,
                        callback: function(e) {
                            t.$set(t.series.tickLine, "color", e)
                        },
                        expression: "series.tickLine.color"
                    }
                })], 1)], 1)], 1), e("chart-base-switch", {
                    attrs: {
                        switchValue: t.series.tick.show
                    },
                    on: {
                        "update:switchValue": function(e) {
                            return t.$set(t.series.tick, "show", e)
                        },
                        "update:switch-value": function(e) {
                            return t.$set(t.series.tick, "show", e)
                        }
                    ...
                    slot: "title"
                }, [t._v(t._s(t.setItem.showTick))])]), e("chart-base-select", {
                    attrs: {
                        selectOption: t.orient,
                        selectValue: t.series.tick.position
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.series.tick, "position", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.series.tick, "position", e)
                        }
                    ...
                    slot: "select"
                }, [t._v(t._s(t.setItem.position))])]), e("chart-base-slider", {
                    attrs: {
                        hideCol: !0,
                        min: 1,
                        baseSliderOption: t.series.tick.length,
                        unit: "px",
                        content: t.setItem.content4
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.series.tick, "length", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.series.tick, "length", e)
                        }
                    ...
                    slot: "title"
                }, [t._v(t._s(t.setItem.tickLength))])]), e("chart-base-slider", {
                    attrs: {
                        hideCol: !0,
                        max: 20,
                        min: 1,
                        baseSliderOption: t.series.tick.width,
                        unit: "px",
                        content: t.setItem.content5
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.series.tick, "width", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.series.tick, "width", e)
                        }
                    ...
                    slot: "title"
                }, [t._v(t._s(t.setItem.tickWidth))])]), e("el-row", {
                    staticStyle: {
                        "margin-top": "15px"
                    }
                }, [e("el-col", {
                ...
                }, [t._v(t._s(t.setItem.tickColor))]), e("el-col", {
                    attrs: {
                        push: 14,
                        span: 4
                    }
                    ...
                    model: {
                        value: t.series.tick.color,
                        callback: function(e) {
                            t.$set(t.series.tick, "color", e)
                        },
                        expression: "series.tick.color"
                    }
                })], 1)], 1)], 1), e("chart-base-switch", {
                    attrs: {
                        switchValue: t.series.tickLabel.show
                    },
                    on: {
                        "update:switchValue": function(e) {
                            return t.$set(t.series.tickLabel, "show", e)
                        },
                        "update:switch-value": function(e) {
                            return t.$set(t.series.tickLabel, "show", e)
                        }
                    ...
                    slot: "title"
                }, [t._v(t._s(t.setItem.showLabel))])]), e("chart-base-slider", {
                    attrs: {
                        hideCol: !0,
                        format: t.formatRotation,
                        max: 180,
                        min: -180,
                        baseSliderOption: t.series.tickLabel.rotate,
                        unit: "°",
                        content: t.setItem.content6
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.series.tickLabel, "rotate", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.series.tickLabel, "rotate", e)
                        }
                    ...
                    slot: "title"
                }, [t._v(t._s(t.setItem.rotate))])]), e("div", {
                    directives: [{
                        name: "show",
                        rawName: "v-show",
                        value: t.showLabel,
                    ...
                    attrs: {
                        type: "text",
                        inputValue: t.series.tickLabel.min,
                        placeholder: t.setItem.content7
                    },
                    on: {
                        "update:inputValue": function(e) {
                            return t.$set(t.series.tickLabel, "min", e)
                        },
                        "update:input-value": function(e) {
                            return t.$set(t.series.tickLabel, "min", e)
                        }
                    ...
                    slot: "input"
                }, [t._v(t._s(t.setItem.min))])]), e("chart-base-input", {
                    attrs: {
                        type: "text",
                        inputValue: t.series.tickLabel.max,
                        placeholder: t.setItem.content8
                    },
                    on: {
                        "update:inputValue": function(e) {
                            return t.$set(t.series.tickLabel, "max", e)
                        },
                        "update:input-value": function(e) {
                            return t.$set(t.series.tickLabel, "max", e)
                        }
                    ...
                    slot: "input"
                }, [t._v(t._s(t.setItem.max))])]), e("chart-base-select", {
                    attrs: {
                        selectOption: t.ratioOption,
                        selectValue: t.series.tickLabel.ratio
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.series.tickLabel, "ratio", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.series.tickLabel, "ratio", e)
                        }
                    ...
                    slot: "select"
                }, [t._v(t._s(t.setItem.ratio))])]), e("chart-base-select", {
                    attrs: {
                        selectOption: t.digitOption,
                        selectValue: t.series.tickLabel.digit
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.series.tickLabel, "digit", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.series.tickLabel, "digit", e)
                        }
                    ...
                    slot: "select"
                }, [t._v(t._s(t.setItem.digit))])])], 1), e("chart-base-input", {
                    attrs: {
                        inputValue: t.series.tickLabel.prefix,
                        placeholder: t.setItem.content9
                    },
                    on: {
                        "update:inputValue": function(e) {
                            return t.$set(t.series.tickLabel, "prefix", e)
                        },
                        "update:input-value": function(e) {
                            return t.$set(t.series.tickLabel, "prefix", e)
                        }
                    ...
                    slot: "input"
                }, [t._v(t._s(t.setItem.prefix))])]), e("chart-base-input", {
                    attrs: {
                        inputValue: t.series.tickLabel.suffix,
                        placeholder: t.setItem.content10
                    },
                    on: {
                        "update:inputValue": function(e) {
                            return t.$set(t.series.tickLabel, "suffix", e)
                        },
                        "update:input-value": function(e) {
                            return t.$set(t.series.tickLabel, "suffix", e)
                        }
                    ...
                    slot: "input"
                }, [t._v(t._s(t.setItem.suffix))])]), e("chart-base-switch", {
                    attrs: {
                        switchValue: t.series.netLine.show
                    },
                    on: {
                        "update:switchValue": function(e) {
                            return t.$set(t.series.netLine, "show", e)
                        },
                        "update:switch-value": function(e) {
                            return t.$set(t.series.netLine, "show", e)
                        }
                    ...
                    slot: "title"
                }, [t._v(t._s(t.setItem.showNet))])]), e("div", {
                    directives: [{
                        name: "show",
                        rawName: "v-show",
                        value: t.series.netLine.show,
                    ...
                    attrs: {
                        ...
                        max: 20,
                        min: 1,
                        baseSliderOption: t.series.netLine.width,
                        unit: "px",
                        content: t.setItem.content11
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.series.netLine, "width", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.series.netLine, "width", e)
                        }
                    ...
                    slot: "title"
                }, [t._v(t._s(t.setItem.netWidth))])]), e("chart-base-select", {
                    attrs: {
                        selectOption: t.lineStyleOption,
                        selectValue: t.series.netLine.type
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.series.netLine, "type", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.series.netLine, "type", e)
                        }
                    ...
                    slot: "select"
                }, [t._v(t._s(t.setItem.netType))])]), e("el-row", {
                    staticStyle: {
                        "margin-top": "15px"
                    }
                }, [e("el-col", {
                ...
                }, [t._v(t._s(t.setItem.netColor))]), e("el-col", {
                    attrs: {
                        push: 13,
                        span: 3
                    }
                    ...
                    model: {
                        value: t.series.netLine.color,
                        callback: function(e) {
                            t.$set(t.series.netLine, "color", e)
                        },
                        expression: "series.netLine.color"
                    }
                })], 1)], 1)], 1), e("chart-base-select", {
                    attrs: {
                        selectOption: t.intervalOption,
                        selectValue: t.series.netLine.interval.value
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.series.netLine.interval, "value", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.series.netLine.interval, "value", e)
                        }
                    ...
                    slot: "select"
                }, [t._v(t._s(t.setItem.netInterval))])]), "custom" == t.series.netLine.interval.value ? e("chart-base-slider", {
                    attrs: {
                        baseSliderOption: t.series.netLine.interval.cusNumber,
                        unit: "个",
                        content: t.setItem.content12
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.series.netLine.interval, "cusNumber", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.series.netLine.interval, "cusNumber", e)
                        }
                    }
                }) : t._e()], 1), e("chart-base-switch", {
                    attrs: {
                        switchValue: t.series.netArea.show
                    },
                    on: {
                        "update:switchValue": function(e) {
                            return t.$set(t.series.netArea, "show", e)
                        },
                        "update:switch-value": function(e) {
                            return t.$set(t.series.netArea, "show", e)
                        }
                    ...
                    slot: "title"
                }, [t._v(t._s(t.setItem.showArea))])]), e("div", {
                    directives: [{
                        name: "show",
                        rawName: "v-show",
                        value: t.series.netArea.show,
                        expression: "series.netArea.show"
                    }]
                }, [e("chart-base-select", {
                    attrs: {
                        selectOption: t.intervalOption,
                        selectValue: t.series.netArea.interval.value
                    },
                    on: {
                        "update:selectValue": function(e) {
                            return t.$set(t.series.netArea.interval, "value", e)
                        },
                        "update:select-value": function(e) {
                            return t.$set(t.series.netArea.interval, "value", e)
                        }
                    ...
                    slot: "select"
                }, [t._v(t._s(t.setItem.areaInterval))])]), "custom" == t.series.netArea.interval.value ? e("chart-base-slider", {
                    attrs: {
                        baseSliderOption: t.series.netArea.interval.cusNumber,
                        unit: "个",
                        content: t.setItem.content12
                    },
                    on: {
                        "update:baseSliderOption": function(e) {
                            return t.$set(t.series.netArea.interval, "cusNumber", e)
                        },
                        "update:base-slider-option": function(e) {
                            return t.$set(t.series.netArea.interval, "cusNumber", e)
                        }
                ...
                }, [t._v(t._s(t.setItem.area1))]), e("el-col", {
                    attrs: {
                        span: 3
                    }
                }, [e("el-color-picker", {
                    ...
                    model: {
                        value: t.series.netArea.colorOne,
                        callback: function(e) {
                            t.$set(t.series.netArea, "colorOne", e)
                        },
                ...
                }, [t._v(t._s(t.setItem.area2))]), e("el-col", {
                    attrs: {
                        span: 3
                    }
                }, [e("el-color-picker", {
                    ...
                    model: {
                        value: t.series.netArea.colorTwo,
                        callback: function(e) {
                            t.$set(t.series.netArea, "colorTwo", e)
                        },
              ...
              , Hn = {
                ...
                mounted() {
                    "ch" != this.lang ? this.setItem = Ie["chartAxis"] : this.setItem = Oe["chartAxis"]
                },
                watch: {
                    axisOption: {
                        handler(t) {
                            Me.a(this.axis, this.axisOption) || (this.axis = L(this.axisOption),
                            this.series = this.axis[t.axisType],
                            this.fontSizeOption = L(v),
                            this.lineStyleOption = L(y),
                            this.intervalOption = L(k),
                            this.ratioOption = L(w),
                            this.digitOption = L(C))
                        },
                        immediate: !0,
                        deep: !0
                    },
                    ...
                    lang(t) {
                        this.setItem = "ch" != t ? Ie["chartAxis"] : Oe["chartAxis"]
                    }
                },
                computed: {
                    chartType() {
                    ...
                    axisGroup() {
                        return "bar" == this.chartType && "compare" != this.chartStyle ? [{
                            value: "xAxisDown",
                            ...
                            value: "yAxisLeft",
                            label: "X-Axis (Bottom Horizontal)"
                        }, {
                            value: "yAxisRight",
                            label: "X-Axis (Top Horizontal)"
                        }] : "compare" == this.chartStyle ? [{
                            value: "xAxisDown",
                    ...
                    showLabel() {
                        if ("bar" == this.chartType && "x" == this.axis.axisType.slice(0, 1) || "bar" != this.chartType && "y" == this.axis.axisType.slice(0, 1))
                            return !0
                    }
                },
                methods: {
              ...
              , Zn = Hn
              , Jn = Le(Zn, qn, Xn, !1, null, null, null)
              , Un = Jn.exports
              , Yn = {
                name: "ChartSetting",
                components: {
                ...
                data() {
                    return {
                        ...
                        chart_id: "",
                        titleOption: L(g.title),
                        subTitleOption: L(g.subtitle),
                        cursorOption: L(g.tooltip),
                        legendOption: L(g.legend),
                        axisOption: L(g.axis),
                        showList: !1,
                        setItem: {
                            echarts: {
                ...
                mounted() {
                    "ch" != this.lang ? this.setItem = Ie["chartSetting"] : this.setItem = Oe["chartSetting"]
                },
                watch: {
                    chartOptions: {
                        handler: function(t, e) {
                            void 0 != t && t.hasOwnProperty("chartAllType") && (this.currentChartType = t.chartAllType,
                            this.chart_id = t.chart_id,
                            this.titleOption = t.defaultOption.title,
                            this.subTitleOption = t.defaultOption.subtitle,
                            this.cursorOption = t.defaultOption.tooltip,
                            this.legendOption = t.defaultOption.legend,
                            this.axisOption = t.defaultOption.axis)
                        }
                    },
                    lang(t) {
                        this.setItem = "ch" != t ? Ie["chartSetting"] : Oe["chartSetting"]
                    }
                },
                computed: {
                    ...Object(f["mapState"])("chartSetting", ["chartLists", "currentChartIndex"]),
                    currentRangeColCheck: {
                        get() {
                            return null == this.currentChartIndex ? {
                                exits: !1,
                                range: [0, 0]
                            } : this.chartLists[this.currentChartIndex].chartOptions.rangeColCheck
                        },
                        set(t) {
                    ...
                    currentRangeRowCheck: {
                        get() {
                            return null == this.currentChartIndex ? {
                                exits: !1,
                                range: [0, 0]
                            } : this.chartLists[this.currentChartIndex].chartOptions.rangeRowCheck
                        },
                        set(t) {
                            this.updateChartItemChartlistOne({
                                key: "rangeRowCheck",
                    ...
                    checkRowDisabled() {
                        return null == this.currentChartIndex || !this.chartLists[this.currentChartIndex].chartOptions.chartData || 1 == this.chartLists[this.currentChartIndex].chartOptions.chartData.length
                    },
                    checkColDisabled() {
                        return null == this.currentChartIndex || !this.chartLists[this.currentChartIndex].chartOptions.chartData || 1 == this.chartLists[this.currentChartIndex].chartOptions.chartData.length
                    },
                    currentRangeConfigCheck: {
                        get() {
                            return null != this.currentChartIndex && this.chartLists[this.currentChartIndex].chartOptions.rangeConfigCheck
                        },
                        set(t) {
                            this.updateChartItemChartlistOne({
                    ...
                    chartTypeTxt: function() {
                        var t, e, n;
                        return "echarts" == this.chart_pro ? t = "echarts" : "highcharts" == this.chart_pro && (t = "highcharts"),
                        "line" == this.chart_type ? ("default" == this.chart_style && (e = this.setItem.echarts.line.default),
                        "smooth" == this.chart_style && (e = this.setItem.echarts.line.smooth),
                        "label" == this.chart_style && (e = this.setItem.echarts.line.label),
                        "doublex" == this.chart_style && (e = "双Y轴折线图"),
                        "linemix" == this.chart_style && (e = "折线柱状混合图"),
                        n = "icon-tubiaozhexiantu",
                        [n, t + " - " + e]) : "area" == this.chart_type ? ("default" == this.chart_style && (e = this.setItem.echarts.area.default),
                        "stack" == this.chart_style && (e = this.setItem.echarts.area.stack),
                        "stackRatio" == this.chart_style && (e = "带标签的堆叠面积图"),
                        n = "icon-fsux_tubiao_duijimianjitu",
                        [n, t + " - " + e]) : "column" == this.chart_type ? ("default" == this.chart_style && (e = this.setItem.echarts.column.default),
                        "stack" == this.chart_style && (e = this.setItem.echarts.column.stack),
                        "stackRatio" == this.chart_style && (e = "百分比堆叠柱状图"),
                        "costComposition" == this.chart_style && (e = "费用构成柱状图"),
                        "polarStack" == this.chart_style && (e = "极坐标系下的堆叠柱状图"),
                        "bar3DPunchCard" == this.chart_style && (e = "3D柱状图"),
                        "contain" == this.chart_style && (e = "比例图"),
                        "special" == this.chart_style && (e = "显示百分比图"),
                        "doubleX" == this.chart_style && (e = "双X轴"),
                        n = "icon-chart",
                        [n, t + " - " + e]) : "bar" == this.chart_type ? ("default" == this.chart_style && (e = this.setItem.echarts.bar.default),
                        "stack" == this.chart_style && (e = this.setItem.echarts.bar.stack),
                        "stackRatio" == this.chart_style && (e = "百分比堆叠条形图"),
                        "compare" == this.chart_style && (e = "条形比较图"),
                        "contain" == this.chart_style && (e = "比例图"),
                        n = "icon-fsux_tubiao_duijizhuzhuangtu1",
                        [n, t + " - " + e]) : "pie" == this.chart_type ? ("default" == this.chart_style && (e = this.setItem.echarts.pie.default),
                        "split" == this.chart_style && (e = this.setItem.echarts.pie.split),
                        "ring" == this.chart_style && (e = this.setItem.echarts.pie.ring),
                        "ringnest" == this.chart_style && (e = "环形嵌套图"),
                        "3D" == this.chart_style && (e = "3D饼图"),
                        "rose" == this.chart_style && ("echarts" == this.chart_pro ? e = "南丁格玫瑰图" : "highcharts" == this.chart_pro && (e = "可变宽度的环形图")),
                        n = "icon-fsux_tubiao_nandingmeiguitu",
                        [n, t + " - " + e]) : "scatter" == this.chart_type ? ("default" == this.chart_style && (e = "默认散点图"),
                        "label" == this.chart_style && (e = "带标签的散点图"),
                        "zoom" == this.chart_style && (e = "自由缩放散点图"),
                        "matrix" == this.chart_style && (e = "散点图矩阵"),
                        n = "icon-fsux_tubiao_qipaotu",
                        [n, t + " - " + e]) : "radar" == this.chart_type ? ("default" == this.chart_style && (e = "默认雷达图"),
                        n = "icon-leidatu",
                        [n, t + " - " + e]) : "funnel" == this.chart_type ? ("default" == this.chart_style && (e = "默认漏斗图"),
                        "inverse" == this.chart_style && (e = "逆漏斗图"),
                        n = "icon-fsux_tubiao_loudoutu",
                        [n, t + " - " + e]) : "gauge" == this.chart_type ? ("default" == this.chart_style && (e = "仪表盘"),
                        "percent" == this.chart_style && (e = "百分比仪表盘"),
                        "solid" == this.chart_style && (e = "活动图"),
                        n = "icon-fsux_tubiao_yibiaopan",
                        [n, t + " - " + e]) : "map" == this.chart_type ? ("china" == this.chart_style ? e = "中国地图" : "province" == this.chart_style ? e = "省份地图" : "cnscatter" == this.chart_style ? e = "中国地图散点图" : "pvscatter" == this.chart_style ? e = "省份地图散点图" : "percent" == this.chart_style && (e = "百分比地图"),
                        n = "icon-fsux_tubiao_ditu",
                        [n, t + " - " + e]) : "earth" == this.chart_type ? [n, t + " - 3D 地球"] : void 0
                    },
                    currentChartDataCache() {
                        return null == this.currentChartIndex ? null : this.chartLists[this.currentChartIndex].chartOptions.chartDataCache
                    },
                    chartXYSeriesList() {
                        if (null == this.currentChartDataCache)
                            return;
                        let t = this.chartLists[this.currentChartIndex].chartOptions.chartDataSeriesOrder;
                        var e = this.currentChartType.split("|")
                          , n = (e[0],
                        e[1])
                          , r = (e[2],
                        {
                        ...
                        if (("line" == n || "column" == n || "area" == n || "scatter" == n) && (null != this.currentChartDataCache.title && i.fix.push({
                            title: "x-axis",
                            type: r["string"],
                            field: this.currentChartDataCache.title.text
                        }),
                        null != this.currentChartDataCache.label))
                            for (var a = 0; a < this.currentChartDataCache.label.length; a++) {
                                var o = t[a];
                                i.change[o] = {
                                    title: "Series" + (o + 1),
                                    index: o,
                                    type: r[this.currentChartDataCache.series_tpye[a]],
                                    field: this.currentChartDataCache.label[a],
                                    id: a
                                },
                                i.option.push({
                                    field: this.currentChartDataCache.label[a],
                    ...
                    currentChartDataSeriesOrder: {
                        get() {
                            return null == this.currentChartIndex ? {} : this.chartLists[this.currentChartIndex].chartOptions.chartDataSeriesOrder
                        },
                        set(t) {
                            this.updateChartItemChartlistOne({
                ...
                methods: {
                    ...Object(f["mapActions"])("chartSetting", ["updateChartItemChartlistOne"]),
                    handleClick(t) {
                        0 != t.index && (this.showList = !1)
                    },
                    getColRowCheckTxt: function(t) {
                        if (t) {
                            e = "";
                            return e = this.currentRangeRowCheck.range[0] == this.currentRangeRowCheck.range[1] ? this.currentRangeRowCheck.range[0] + 1 : this.currentRangeRowCheck.range[0] + 1 + "至" + (this.currentRangeRowCheck.range[1] + 1),
                            e
                        }
                        var e = "";
                        return e = this.currentRangeColCheck.range[0] == this.currentRangeColCheck.range[1] ? this.currentRangeColCheck.range[0] + 1 : this.currentRangeColCheck.range[0] + 1 + "至" + (this.currentRangeColCheck.range[1] + 1),
                        e
                    },
                    checkBoxChange: function() {
                        var t = this.chartLists[this.currentChartIndex].chartOptions.chart_id
                          , e = this.currentRangeRowCheck
                          , n = this.currentRangeColCheck
                          , r = this.currentRangeConfigCheck;
                        xe(t, e, n, r)
                    },
                    handleSeriseCommand: function(t) {
                        var e = t.series
                          , n = t.option
                          , r = L(this.currentChartDataSeriesOrder)
                          , i = n.id
                          , a = e.index
                          , o = e.id
                          , s = r[i];
                        r[i] = a,
                        r[o] = s,
                        this.currentChartDataSeriesOrder = r,
                        Ae(this.chartLists[this.currentChartIndex].chartOptions, this.currentChartDataSeriesOrder)
                    }
                }
            }
              , Kn = Yn
              , _n = (n("77ad"),
            Le(Kn, o, s, !1, null, null, null))
              , $n = _n.exports
              , tr = function() {
                var t = this
                  , e = t._self._c;
              ...
              , rr = nr
              , ir = Le(rr, tr, er, !1, null, "4be53480", null)
              , ar = ir.exports
              , or = n("164e")
              , sr = n.n(or);
            const lr = he.state.chartSetting;
            function cr(t, e) {
                ...
                new xt.a({
                    ...
                    computed: {
                        chartOptions() {
                            return lr.currentChartIndex ? lr.chartLists[lr.currentChartIndex].chartOptions : null
                        }
                    },
            ...
            function ur(t, e, n, r, i) {
                let a = n || N("chart");
                t.id = a,
                D.defaultOption.series = [];
                let o = 10 * Math.random();
                D.chartAllType = o > 5 ? "echarts|pie|default" : "echarts|line|default";
                let s = hr(D, a, D.chartAllType, e, r, i)
                ...
                return lr.currentChartIndex = lr.chartLists.length,
                lr.chartLists.push(c),
                new xt.a({
                    el: "#render" + a,
                    store: he,
                    data() {
                    ...
                    computed: {
                        options() {
                            let t = lr.chartLists.find(t => t.chart_id == this.chart_Id);
                            return t ? t.chartOptions : null
                        },
                        active() {
                            let t = lr.chartLists.find(t => t.chart_id == this.chart_Id);
            ...
            function hr(t, e, n, r, i, a, o, s, l, c, u) {
                var h = {}
                  , f = n.split("|")
                  , p = f[0]
                  , d = f[1]
                ...
                h.rangeColCheck = y,
                h.rangeRowCheck = v,
                h.rangeConfigCheck = x;
                var A = q(r, i, y, v);
                h.rangeSplitArray = A;
                var w = H(r, A, p, d, g);
                h.chartDataCache = w;
                var C = Z(w.series[0].length);
                h.chartDataSeriesOrder = C,
                h.chartTheme = o;
                var S = J(m, w, C, p, d, g);
                return h.defaultOption = S,
                h
            }
            function fr(t) {
                let e = lr.chartLists.findIndex(e => e.chart_id == t);
                return lr.currentChartIndex = e,
                lr.chartLists[lr.currentChartIndex].chartOptions
            }
            function pr(t) {
                let e = lr.chartLists.findIndex(e => e.chart_id == t);
                var n = lr.chartLists[e].chartOptions.chartAllType
                  , r = n.split("|")
                  , i = r[0];
                r[1],
                r[2];
                "echarts" == i && sr.a.getInstanceById(h()("#" + t).attr("_echarts_instance_")).resize()
            }
            function dr(t) {
                let e = lr.chartLists.findIndex(e => e.chart_id == t);
                if (lr.chartLists.splice(e, 1),
                lr.currentChartIndex--,
                lr.currentChartIndex < 0) {
                    if (lr.chartLists[0])
                        return void (lr.currentChartIndex = 0);
                    lr.currentChartIndex = null
                }
            }
            function gr(t) {
                let e = lr.chartLists.findIndex(e => e.chart_id == t);
                return lr.chartLists[e].chartOptions
            }
            function mr(t) {
                lr.chartLists.push(t)
            }
            const br = [$n, ar]
              , vr = function(t, e={}) {
                vr.componentInstalled || (br.map(e => {
                    t.component(e.name, e)
                }
                ),
                vr.componentInstalled = !0),
                vr.storeRegistered || e.store && (e.store.registerModule("chartSetting", ce),
                vr.storeRegistered = !0)
            };
            "undefined" !== typeof window && window.Vue && vr(window.Vue);
            var yr = {
                install: vr,
                ...br,
                initChart: cr,
...
/* ---- begin cross-sheet chart refresh patch ---- */
(function() {
    try {
        // wait until both luckysheet and chartmix are available
        function ready(cb) {
            var t0 = +new Date();
            (function wait() {
                if (window.luckysheet && window.chartmix && typeof window.chartmix.renderChart === "function") {
                    return cb();
                }
                if (+new Date() - t0 > 30000)
                    return;
                // give up after 30s
                setTimeout(wait, 200);
            }
        ...
        ready(function() {
            var container = document.querySelector('.luckysheet') || document.getElementById('luckysheet');
            if (!container)
                return;
            var throttleMs = 250;
            var last = 0;
            ...
            function refreshAllCharts() {
                if (!window.chartmix)
                    return;
                try {
                    // Find chart containers by id prefix 'render' (plugin uses 'render'+chart_id)
                    var nodes = document.querySelectorAll('[id^="render"]');
                    nodes.forEach(function(node) {
                        var id = node.id.replace(/^render/, '');
                        // chart id used by plugin
                        if (!id)
                            return;
                        try {
                            // Prefer to call renderChart with chart json if available
                            if (typeof window.chartmix.getChartJson === "function") {
                                var json = window.chartmix.getChartJson(id);
                                // If getChartJson returned the full chartOptions object, pass it in
                                if (json) {
                                    window.chartmix.renderChart({
                                        chartOptions: json,
                                        chart_id: id
                                    });
                                    return;
                            ...
                            // fallback: call renderChart with just the id
                            window.chartmix.renderChart(id);
                        } catch (e) {
                            // swallow per-chart errors
                            console.warn("chartmix: error refreshing chart", id, e);
                        }
                    });
                } catch (e) {
                    console.error("chartmix: refreshAllCharts failed", e);
                }
            }
            ...
            // Observe changes to characterData, childList and subtree so edits on other sheets are captured.
            ...
            // Also refresh on explicit Luckysheet events if available
            if (window.luckysheet && window.luckysheet.refreshChartData) {
                // some builds expose a refresh hook; call it too (non-breaking)
                var orig = window.luckysheet.refreshChartData;
                window.luckysheet.refreshChartData = function() {
                    try {
                        refreshAllCharts();
                    } catch (e) {}
            ...
            // Optional: initial refresh to ensure charts reflect current state
            setTimeout(refreshAllCharts, 500);

            // expose for debug
            window.__chartmix_force_refresh_all_charts = refreshAllCharts;
        });
    } catch (err) {
        console.error("chartmix patch failed", err);
    }
}
)();
/* ---- end cross-sheet chart refresh patch ---- */
