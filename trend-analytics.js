    ...
    $.fn.trendAnalytics = function (options) {
            ...
            <div class="modal-content">
              ...
              <div class="modal-body p-0">
                <div class="filter-container">
                   <div class="row g-2 align-items-center sim-toolbar">
                        <div class="col-auto">
                        ...
                        <div class="col-auto"> <button class="btn-apply px-3 py-1 bg-blue-500 rounded btn-sm mt-3">Apply</button></div>
                        <div class="col-auto"> <button class="btn-reset px-3 py-1 rounded btn-sm mt-3">Reset</button></div>
                        <div class="col-auto"> <button class="btn-ml-trend px-3 py-1 bg-green-500 rounded btn-sm mt-3">🧠 ML Trend</button></div>
                </div>
        ...
        function calcSimulated(d) {
            ...
            if (shrink === d.plannedShrinkage && attr === (d.plannedAttrition ?? 0)) {
                ...
                if (shrinkInput || isMLTrend)
                    fteReq = d.fteRequired != null ? d.fteRequired * (1 - d.plannedShrinkage / 100) / (1 - shrink / 100) : null;
                else
                    fteReq = d.fteRequired;

                if ((attrInput && d.week != weeks[0]) || isMLTrend)
                    fteAvail = fteAvailPreWk[d.lob] != null ? fteAvailPreWk[d.lob] * (1 - attr / 100) : d.fteAvailable != null ? d.fteAvailable * (1 - attr / 100) : null;
                else {
